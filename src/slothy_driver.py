...
slothy.config.outputs = ["x3","x4","x5","x6","x7","x8","x11","x12","x13","x14","x15","x16","x17",
    "v0","v1","v2","v3","v4","v9","v10","v11","v13","v14","v15","v16","v17","v18","v19","v20","v21","v22","v23","v24","v25","v26","v27","v28","v29","v30"]
