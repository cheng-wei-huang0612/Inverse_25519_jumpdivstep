...
# example
slothy.load_source_from_file("before_loop_clean.S")
...
slothy.config.outputs = ["x6","x7","x8","x9","x10","x11","x12","x13",
                         ...
                         "v11","v12","v13","v14","v15","v16","v18","sp"
                         ]
slothy.config.reserved_regs = ["x0","x1","x2","x3","x4","x5","x6",
                                "x24","x25","x26","x27","x28",
                               "x29","x30"]
...
slothy.optimize()
slothy.write_source_to_file("before_loop_opt_a72.s")