...
#define STR_U  "-617228368"
#define STR_VV "-346612632"
#define STR_R  "349348834"
#define STR_SS "-1671719641"
...
int main(void)
{
    ...
    big30_t V_input = {1073741820, 1073741823, 1073741823, 1073741823, 356843519, 60292190, 847693037, 565127275, 6898}; 
    big30_t S_input = {1073741808, 1073741823, 1073741823, 1073741823, 412909567, 96923487, 169542127, 113025455, 27594};
    mpz_from_big30(mpV, &V_input);
    mpz_from_big30(mpS, &S_input);
