...
def cpt_inv(x):
    ...
    # a = (T_list[1][0][0] * T_list[0][0][1]) % p
    # b = (T_list[1][0][1] * T_list[0][1][1]) % p
    # c = (T_list[1][1][0] * T_list[0][0][1]) % p
    # d = (T_list[1][1][1] * T_list[0][1][1]) % p

    # a = (T_list[2][0][0] * (a + b)) % p
    # b = (T_list[2][0][1] * (c + d)) % p
    # v = (a + b) % p
    # v = v % p
