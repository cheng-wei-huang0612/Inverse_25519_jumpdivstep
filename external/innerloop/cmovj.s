...
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS0=stack256#1
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS0=0(%rsp)
vmovapd %ymm1,0(%rsp)
...
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS1=stack256#2
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS1=32(%rsp)
vmovapd %ymm1,32(%rsp)
...
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS2=stack256#3
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS2=64(%rsp)
vmovapd %ymm1,64(%rsp)
...
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS3=stack256#4
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS3=96(%rsp)
vmovapd %ymm1,96(%rsp)
...
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS4=stack256#5
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS4=128(%rsp)
...
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS5=stack256#6
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS5=160(%rsp)
...
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS6=stack256#7
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS6=192(%rsp)
...
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS7=stack256#8
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS7=224(%rsp)
...
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS8=stack256#9
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS8=256(%rsp)
...
# qhasm:       t2 = g0
# asm 1: mov  <g0=int64#6,>t2=int64#7
# asm 2: mov  <g0=%r9,>t2=%rax
mov  %r9,%rax
...
# qhasm:       t2 *= v
# asm 1: imul  <v=int64#11,<t2=int64#7
# asm 2: imul  <v=%r13,<t2=%rax
imul  %r13,%rax

# qhasm:       rax = f0
# asm 1: mov  <f0=int64#5,>rax=int64#8
# asm 2: mov  <f0=%r8,>rax=%r10
mov  %r8,%r10

# qhasm:       rax *= r
# asm 1: imul  <r=int64#13,<rax=int64#8
# asm 2: imul  <r=%r15,<rax=%r10
imul  %r15,%r10
...
# qhasm:       f0 += t2
# asm 1: add  <t2=int64#7,<f0=int64#5
# asm 2: add  <t2=%rax,<f0=%r8
add  %rax,%r8

# qhasm:       g0 += rax
# asm 1: add  <rax=int64#8,<g0=int64#6
# asm 2: add  <rax=%r10,<g0=%r9
add  %r10,%r9
...
# qhasm: g+=g0       
# asm 1: add  <g0=int64#6,<g=int64#3
# asm 2: add  <g0=%r9,<g=%rdx
add  %r9,%rdx

# qhasm: FVGS0 = stack_FVGS0
# asm 1: vmovapd <stack_FVGS0=stack256#1,>FVGS0=reg256#1
# asm 2: vmovapd <stack_FVGS0=0(%rsp),>FVGS0=%ymm0
vmovapd 0(%rsp),%ymm0
...
# asm 1: vpinsrq $0x0,<u=int64#10,<uuss=reg256#3%128,<uuss=reg256#3%128
# asm 2: vpinsrq $0x0,<u=%r12,<uuss=%xmm2,<uuss=%xmm2
vpinsrq $0x0,%r12,%xmm2,%xmm2
...
# asm 1: vpinsrq $0x0,<v=int64#11,<vvrr=reg256#4%128,<vvrr=reg256#4%128
# asm 2: vpinsrq $0x0,<v=%r13,<vvrr=%xmm3,<vvrr=%xmm3
vpinsrq $0x0,%r13,%xmm3,%xmm3
...
# asm 1: vpinsrq $0x1,<s=int64#12,<uuss=reg256#3%128,<uuss=reg256#3%128
# asm 2: vpinsrq $0x1,<s=%r14,<uuss=%xmm2,<uuss=%xmm2
vpinsrq $0x1,%r14,%xmm2,%xmm2
...
# asm 1: vpinsrq $0x1,<r=int64#13,<vvrr=reg256#4%128,<vvrr=reg256#4%128
# asm 2: vpinsrq $0x1,<r=%r15,<vvrr=%xmm3,<vvrr=%xmm3
vpinsrq $0x1,%r15,%xmm3,%xmm3
...
# asm 1: vpermq $0x4e,<FVGS0=reg256#1,>GSFV0=reg256#5
# asm 2: vpermq $0x4e,<FVGS0=%ymm0,>GSFV0=%ymm4
vpermq $0x4e,%ymm0,%ymm4
...
# asm 1: vpmuldq <uuss0=reg256#7,<FVGS0=reg256#1,>ta=reg256#9
# asm 2: vpmuldq <uuss0=%ymm6,<FVGS0=%ymm0,>ta=%ymm8
vpmuldq %ymm6,%ymm0,%ymm8
...
# asm 1: vpmuldq <uuss1=reg256#3,<FVGS0=reg256#1,>ta=reg256#1
# asm 2: vpmuldq <uuss1=%ymm2,<FVGS0=%ymm0,>ta=%ymm0
...
# qhasm: 4x out1 = ta + tb
# asm 1: vpaddq <ta=reg256#1,<tb=reg256#5,>out1=reg256#1
# asm 2: vpaddq <ta=%ymm0,<tb=%ymm4,>out1=%ymm0
...
# asm 1: vpaddq <out1=reg256#1,<out1plus=reg256#15,<out1=reg256#1
# asm 2: vpaddq <out1=%ymm0,<out1plus=%ymm14,<out1=%ymm0
...
# asm 1: vpaddq <out1=reg256#1,<carryy=reg256#9,<out1=reg256#1
# asm 2: vpaddq <out1=%ymm0,<carryy=%ymm8,<out1=%ymm0
...
# asm 1: vpmuldq <out1=reg256#1,<_inv19_2p30x4=reg256#10,>d1=reg256#5
# asm 2: vpmuldq <out1=%ymm0,<_inv19_2p30x4=%ymm9,>d1=%ymm4
vpmuldq %ymm0,%ymm9,%ymm4
...
# qhasm: 4x out1 -= d1x19
# asm 1: vpsubq <d1x19=reg256#9,<out1=reg256#1,<out1=reg256#1
# asm 2: vpsubq <d1x19=%ymm8,<out1=%ymm0,<out1=%ymm0
...
# asm 1: vpaddq <out1=reg256#1,<_2p63m2p33x4=reg256#2,>carryy=reg256#1
# asm 2: vpaddq <out1=%ymm0,<_2p63m2p33x4=%ymm1,>carryy=%ymm0
...
# asm 1: vpaddq <out2=reg256#13,<_2p63m2p33x4=reg256#2,>carryy=reg256#1
# asm 2: vpaddq <out2=%ymm12,<_2p63m2p33x4=%ymm1,>carryy=%ymm0
vpaddq %ymm12,%ymm1,%ymm0
...
# asm 1: vpaddq <out3=reg256#10,<carryy=reg256#1,<out3=reg256#10
# asm 2: vpaddq <out3=%ymm9,<carryy=%ymm0,<out3=%ymm9
...
# asm 1: vpaddq <out3=reg256#10,<_2p63m2p33x4=reg256#2,>carryy=reg256#1
# asm 2: vpaddq <out3=%ymm9,<_2p63m2p33x4=%ymm1,>carryy=%ymm0
...
# asm 1: vpaddq <out4=reg256#14,<carryy=reg256#1,<out4=reg256#14
# asm 2: vpaddq <out4=%ymm13,<carryy=%ymm0,<out4=%ymm13
vpaddq %ymm13,%ymm0,%ymm13
...
# asm 1: vpaddq <out4=reg256#14,<_2p63m2p33x4=reg256#2,>carryy=reg256#1
# asm 2: vpaddq <out4=%ymm13,<_2p63m2p33x4=%ymm1,>carryy=%ymm0
vpaddq %ymm13,%ymm1,%ymm0
...
# asm 1: vpaddq <out5=reg256#10,<carryy=reg256#1,<out5=reg256#10
# asm 2: vpaddq <out5=%ymm9,<carryy=%ymm0,<out5=%ymm9
vpaddq %ymm9,%ymm0,%ymm9
...
# asm 1: vpaddq <out5=reg256#10,<_2p63m2p33x4=reg256#2,>carryy=reg256#1
# asm 2: vpaddq <out5=%ymm9,<_2p63m2p33x4=%ymm1,>carryy=%ymm0
vpaddq %ymm9,%ymm1,%ymm0
...
# asm 1: vpaddq <out6=reg256#15,<carryy=reg256#1,<out6=reg256#15
# asm 2: vpaddq <out6=%ymm14,<carryy=%ymm0,<out6=%ymm14
...
# asm 1: vpaddq <out6=reg256#15,<_2p63m2p33x4=reg256#2,>carryz=reg256#1
# asm 2: vpaddq <out6=%ymm14,<_2p63m2p33x4=%ymm1,>carryz=%ymm0
vpaddq %ymm14,%ymm1,%ymm0
...
# asm 1: vpsrlq $30,<carryz=reg256#1,<carryz=reg256#1
# asm 2: vpsrlq $30,<carryz=%ymm0,<carryz=%ymm0
vpsrlq $30,%ymm0,%ymm0
...
# asm 1: vpaddq <out7=reg256#14,<carryz=reg256#1,<out7=reg256#14
# asm 2: vpaddq <out7=%ymm13,<carryz=%ymm0,<out7=%ymm13
vpaddq %ymm13,%ymm0,%ymm13
...
# asm 1: vpaddq <out7=reg256#14,<_2p63m2p33x4=reg256#2,>carryz=reg256#1
# asm 2: vpaddq <out7=%ymm13,<_2p63m2p33x4=%ymm1,>carryz=%ymm0
vpaddq %ymm13,%ymm1,%ymm0
...
# asm 1: vpaddq <out8=reg256#7,<carryz=reg256#1,<out8=reg256#7
# asm 2: vpaddq <out8=%ymm6,<carryz=%ymm0,<out8=%ymm6
...
# asm 1: vpaddq <out8=reg256#7,<_2p63m2p33x4=reg256#2,>carryz=reg256#1
# asm 2: vpaddq <out8=%ymm6,<_2p63m2p33x4=%ymm1,>carryz=%ymm0
...
# asm 1: vpaddq <out9=reg256#5,<carryz=reg256#1,<out9=reg256#5
# asm 2: vpaddq <out9=%ymm4,<carryz=%ymm0,<out9=%ymm4
...
# qhasm: a4 = z if !carry
# asm 1: cmovae <z=int64#1,<a4=int64#3
# asm 2: cmovae <z=%rdi,<a4=%rdx
cmovae %rdi,%rdx

# qhasm: a5 = z if !carry
# asm 1: cmovae <z=int64#1,<a5=int64#4
# asm 2: cmovae <z=%rdi,<a5=%rcx
cmovae %rdi,%rcx

# qhasm: a6 = z if !carry
# asm 1: cmovae <z=int64#1,<a6=int64#5
# asm 2: cmovae <z=%rdi,<a6=%r8
cmovae %rdi,%r8
