...
# qhasm: t0 = a0
# asm 1: mov  <a0=int64#2,>t0=int64#6
# asm 2: mov  <a0=%rsi,>t0=%r9
mov  %rsi,%r9

# qhasm: t1 = a1
# asm 1: mov  <a1=int64#4,>t1=int64#7
# asm 2: mov  <a1=%rcx,>t1=%rax
mov  %rcx,%rax

# qhasm: t2 = a2
# asm 1: mov  <a2=int64#5,>t2=int64#8
# asm 2: mov  <a2=%r8,>t2=%r10
mov  %r8,%r10

# qhasm: h  = a3
# asm 1: mov  <a3=int64#1,>h=int64#9
# asm 2: mov  <a3=%rdi,>h=%r11
mov  %rdi,%r11

# qhasm: carry? a0 -= mem64[ input_2 + 160 ]
# asm 1: subq 160(<input_2=int64#3),<a0=int64#2
# asm 2: subq 160(<input_2=%rdx),<a0=%rsi
subq 160(%rdx),%rsi

# qhasm: carry? a1 -= mem64[ input_2 + 168 ] - carry
# asm 1: sbbq 168(<input_2=int64#3),<a1=int64#4
# asm 2: sbbq 168(<input_2=%rdx),<a1=%rcx
sbbq 168(%rdx),%rcx

# qhasm: carry? a2 -= mem64[ input_2 + 176 ] - carry
# asm 1: sbbq 176(<input_2=int64#3),<a2=int64#5
# asm 2: sbbq 176(<input_2=%rdx),<a2=%r8
sbbq 176(%rdx),%r8

# qhasm: carry? a3 -= mem64[ input_2 + 184 ] - carry
# asm 1: sbbq 184(<input_2=int64#3),<a3=int64#1
# asm 2: sbbq 184(<input_2=%rdx),<a3=%rdi
sbbq 184(%rdx),%rdi

# qhasm: a0 = t0 if carry
# asm 1: cmovc <t0=int64#6,<a0=int64#2
# asm 2: cmovc <t0=%r9,<a0=%rsi
cmovc %r9,%rsi

# qhasm: a1 = t1 if carry
# asm 1: cmovc <t1=int64#7,<a1=int64#4
# asm 2: cmovc <t1=%rax,<a1=%rcx
cmovc %rax,%rcx

# qhasm: a2 = t2 if carry
# asm 1: cmovc <t2=int64#8,<a2=int64#5
# asm 2: cmovc <t2=%r10,<a2=%r8
cmovc %r10,%r8

# qhasm: a3 = h  if carry
# asm 1: cmovc <h=int64#9,<a3=int64#1
# asm 2: cmovc <h=%r11,<a3=%rdi
cmovc %r11,%rdi
...
# asm 2: movq <t0=%rax,<stack_FVGS0=176(%rsp)
movq %rax,176(%rsp)
...
# asm 2: movq <t0=%rax,<stack_FVGS1=208(%rsp)
movq %rax,208(%rsp)
...
# asm 2: movq <a0=%rsi,<stack_FVGS2=240(%rsp)
movq %rsi,240(%rsp)
...
# asm 2: movq <t0=%rsi,<stack_FVGS5=336(%rsp)
movq %rsi,336(%rsp)
...
# asm 2: movq <a2=%r8,<stack_FVGS6=368(%rsp)
movq %r8,368(%rsp)
...
# asm 2: movq <t0=%rsi,<stack_FVGS7=400(%rsp)
movq %rsi,400(%rsp)
...
# qhasm: minv = mem64[ input_2 + 480]
# asm 1: movq   480(<input_2=int64#3),>minv=int64#1
# asm 2: movq   480(<input_2=%rdx),>minv=%rdi
movq   480(%rdx),%rdi

# qhasm: stack_minv = minv
# asm 1: movq <minv=int64#1,>stack_minv=stack64#9
# asm 2: movq <minv=%rdi,>stack_minv=64(%rsp)
movq %rdi,64(%rsp)
...
# asm 2: movq <stack_FVGS1=192(%rsp),>f0=%rsi
movq 192(%rsp),%rsi
...
# asm 2: movq <_m2p20=%r8,>stack_m2p20=72(%rsp)
movq %r8,72(%rsp)
...
# asm 2: movq <_2p20=%rax,>stack_2p20=80(%rsp)
movq %rax,80(%rsp)
...
# asm 2: movq <_m2p41=%rax,>stack_m2p41=88(%rsp)
movq %rax,88(%rsp)
...
# asm 2: movq <_m2p62=%rax,>stack_m2p62=96(%rsp)
movq %rax,96(%rsp)
...
# asm 2: movq <_2p20a2p41=%rax,>stack_2p20a2p41=104(%rsp)
movq %rax,104(%rsp)
...
# asm 2: addq <stack_m2p62=96(%rsp),<grs=%r9
addq 96(%rsp),%r9
...
# asm 2: movq <r=%r9,<stack_vvrr=912(%rsp)
movq %r9,912(%rsp)
...
# asm 2: imulq <stack_uuss=864(%rsp),<r=%r9
imulq 864(%rsp),%r9
...
# asm 2: movq <stack_uuss=880(%rsp),>stimesolds=%rdx
movq 880(%rsp),%rdx
...
# asm 2: imulq <stack_vvrr=912(%rsp),<s=%rsi
imulq 912(%rsp),%rsi
...
# asm 2: movq <stack_FVGS1=192(%rsp),>t1=%rsi
movq 192(%rsp),%rsi
...
# asm 2: movq <stack_FVGS0=176(%rsp),>t0=%rsi
movq 176(%rsp),%rsi
...
# asm 2: movq <stack_FVGS2=224(%rsp),>t0=%rsi
movq 224(%rsp),%rsi

# qhasm:   t1 = stack_FVGS3[0]
# asm 1: movq <stack_FVGS3=stack256#5,>t1=int64#3
# asm 2: movq <stack_FVGS3=256(%rsp),>t1=%rdx
movq 256(%rsp),%rdx
...
# asm 1: movq <stack_FVGS1=stack256#3,>a1=int64#4
# asm 2: movq <stack_FVGS1=200(%rsp),>a1=%rcx
movq 200(%rsp),%rcx
...
# asm 1: movq <stack_FVGS2=stack256#4,>a2=int64#5
# asm 2: movq <stack_FVGS2=232(%rsp),>a2=%r8
movq 232(%rsp),%r8
...
# asm 1: movq <stack_FVGS3=stack256#5,>a3=int64#6
# asm 2: movq <stack_FVGS3=264(%rsp),>a3=%r9
movq 264(%rsp),%r9
...
# asm 1: movq <stack_FVGS4=stack256#6,>a4=int64#7
# asm 2: movq <stack_FVGS4=296(%rsp),>a4=%rax
movq 296(%rsp),%rax
...
# asm 1: movq <stack_FVGS5=stack256#1,>a5=int64#8
# asm 2: movq <stack_FVGS5=136(%rsp),>a5=%r10
movq 136(%rsp),%r10
