...
int64_t tabl1[60]={0x3FFFFFFFLL, 0x3FFFFFFFLL, 0x3FFFFFFFLL, 0x3FFFFFFFLL,
...
/* To set up the table for an arbitrary prime of size 256 or less 
   ...
   compute the prime radix 2^30, and enter p0, ... p8 in positions
   20, 24, ... 52; finally, replace position 56 with 1/p mod 2^30.
