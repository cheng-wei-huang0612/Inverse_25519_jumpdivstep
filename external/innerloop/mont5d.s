...
# asm 1: movq   480(<table=int64#2),>minv=int64#3
# asm 2: movq   480(<table=%rsi),>minv=%rdx
movq   480(%rsi),%rdx
...
# qhasm: carry? a3 += t3
# asm 1: add  <t3=int64#7,<a3=int64#1
# asm 2: add  <t3=%rax,<a3=%rdi
add  %rax,%rdi
...
# asm 1: mulx  184(<table=int64#2),>t3=int64#3,>t4=int64#5
# asm 2: mulx  184(<table=%rsi),>t3=%rdx,>t4=%r8
mulx  184(%rsi),%rdx,%r8

# qhasm: carry? t3 += a3
# asm 1: add  <a3=int64#1,<t3=int64#3
# asm 2: add  <a3=%rdi,<t3=%rdx
add  %rdi,%rdx

# qhasm: t4 += h + carry
# asm 1: adc <h=int64#4,<t4=int64#5
# asm 2: adc <h=%rcx,<t4=%r8
adc %rcx,%r8

# qhasm: inplace stack_FVGS2[2] = t3
# asm 1: movq <t3=int64#3,<stack_FVGS2=stack256#4
# asm 2: movq <t3=%rdx,<stack_FVGS2=240(%rsp)
movq %rdx,240(%rsp)

# qhasm: inplace stack_FVGS3[2] = t4
# asm 1: movq <t4=int64#5,<stack_FVGS3=stack256#5
# asm 2: movq <t4=%r8,<stack_FVGS3=272(%rsp)
movq %r8,272(%rsp)
...
# qhasm: inplace stack_FVGS5[2] = a0
# asm 1: movq <a0=int64#1,<stack_FVGS5=stack256#7
# asm 2: movq <a0=%rdi,<stack_FVGS5=336(%rsp)
movq %rdi,336(%rsp)
...
# qhasm: inplace stack_FVGS6[2] = a1
# asm 1: movq <a1=int64#1,<stack_FVGS6=stack256#8
# asm 2: movq <a1=%rdi,<stack_FVGS6=368(%rsp)
movq %rdi,368(%rsp)
...
# qhasm: inplace stack_FVGS7[2] = a2
# asm 1: movq <a2=int64#1,<stack_FVGS7=stack256#9
# asm 2: movq <a2=%rdi,<stack_FVGS7=400(%rsp)
movq %rdi,400(%rsp)
...
# asm 2: movq <a3=%rdi,<stack_FVGS8=432(%rsp)
movq %rdi,432(%rsp)

# qhasm: a3 = stack_FVGS8[2]
# asm 1: movq <stack_FVGS8=stack256#10,>a3=int64#1
# asm 2: movq <stack_FVGS8=432(%rsp),>a3=%rdi
movq 432(%rsp),%rdi
...
# qhasm: a2 = stack_FVGS7[2]
# asm 1: movq <stack_FVGS7=stack256#9,>a2=int64#1
# asm 2: movq <stack_FVGS7=400(%rsp),>a2=%rdi
movq 400(%rsp),%rdi
...
# qhasm: a1 = stack_FVGS6[2]
# asm 1: movq <stack_FVGS6=stack256#8,>a1=int64#1
# asm 2: movq <stack_FVGS6=368(%rsp),>a1=%rdi
movq 368(%rsp),%rdi
...
# qhasm: a0 = stack_FVGS5[2]
# asm 1: movq <stack_FVGS5=stack256#7,>a0=int64#1
# asm 2: movq <stack_FVGS5=336(%rsp),>a0=%rdi
movq 336(%rsp),%rdi
...
# qhasm: a0 = stack_FVGS5[2]
# asm 1: movq <stack_FVGS5=stack256#7,>a0=int64#3
# asm 2: movq <stack_FVGS5=336(%rsp),>a0=%rdx
movq 336(%rsp),%rdx
...
# qhasm: a1 = stack_FVGS6[2]
# asm 1: movq <stack_FVGS6=stack256#8,>a1=int64#4
# asm 2: movq <stack_FVGS6=368(%rsp),>a1=%rcx
movq 368(%rsp),%rcx
...
# qhasm: a2 = stack_FVGS7[2]
# asm 1: movq <stack_FVGS7=stack256#9,>a2=int64#3
# asm 2: movq <stack_FVGS7=400(%rsp),>a2=%rdx
movq 400(%rsp),%rdx
...
# qhasm: a3 = stack_FVGS8[2]
# asm 1: movq <stack_FVGS8=stack256#10,>a3=int64#4
# asm 2: movq <stack_FVGS8=432(%rsp),>a3=%rcx
movq 432(%rsp),%rcx
...
# asm 2: vmovapd <_2p33x4=%ymm0,>stack_2p33x4=736(%rsp)
...
# asm 2: vmovapd <_2p63x4=%ymm0,>stack_2p63x4=768(%rsp)
...
# asm 1: vmovapd <_2p63m2p33x4=reg256#1,>stack_2p63m2p33x4=stack256#22
# asm 2: vmovapd <_2p63m2p33x4=%ymm0,>stack_2p63m2p33x4=800(%rsp)
...
# asm 1: vmovapd <_2p29x4=reg256#1,>stack_2p29x4=stack256#23
# asm 2: vmovapd <_2p29x4=%ymm0,>stack_2p29x4=832(%rsp)
vmovapd %ymm0,832(%rsp)

# qhasm: i = 10
# asm 1: mov  $10,>i=int64#2
# asm 2: mov  $10,>i=%rsi
mov  $10,%rsi
...
# asm 2: vmovapd <stack_2p63x4=768(%rsp),>_2p63x4=%ymm7
vmovapd 768(%rsp),%ymm7
...
# asm 2: vmovapd <stack_2p33x4=736(%rsp),>_2p33x4=%ymm8
...
# asm 1: vmovapd <stack_2p63m2p33x4=stack256#22,>_2p63m2p33x4=reg256#8
...
# asm 2: vmovapd <stack_2p33x4=736(%rsp),>_2p33x4=%ymm5
vmovapd 736(%rsp),%ymm5
...
# asm 2: movq <v=%rax,<stack_vvrr=896(%rsp)
movq %rax,896(%rsp)

# qhasm:   inplace stack_uuss[0] = u
# asm 1: movq <u=int64#3,<stack_uuss=stack256#24
# asm 2: movq <u=%rdx,<stack_uuss=864(%rsp)
movq %rdx,864(%rsp)

# qhasm:   inplace stack_uuss[2] = s
# asm 1: movq <s=int64#9,<stack_uuss=stack256#24
# asm 2: movq <s=%r11,<stack_uuss=880(%rsp)
movq %r11,880(%rsp)

# qhasm:   inplace stack_vvrr[2] = r
# asm 1: movq <r=int64#5,<stack_vvrr=stack256#25
# asm 2: movq <r=%r8,<stack_vvrr=912(%rsp)
movq %r8,912(%rsp)
...
# asm 2: movq <stack_uuss=864(%rsp),>t0=%r13
movq 864(%rsp),%r13
...
# asm 2: movq <stack_vvrr=912(%rsp),>t1=%r14
movq 912(%rsp),%r14
...
# asm 2: movq <stack_vvrr=896(%rsp),>rtimesoldv=%r15
movq 896(%rsp),%r15
...
# asm 2: movq <stack_uuss=880(%rsp),>stimesolds=%rbx
movq 880(%rsp),%rbx
...
# asm 1: imulq <stack_uuss=stack256#24,<r=int64#5
# asm 2: imulq <stack_uuss=864(%rsp),<r=%r8
imulq 864(%rsp),%r8

# qhasm:   s *= stack_vvrr[2]
# asm 1: imulq <stack_vvrr=stack256#25,<s=int64#10
# asm 2: imulq <stack_vvrr=912(%rsp),<s=%r12
imulq 912(%rsp),%r12
...
# asm 2: movq <v=%r11,<stack_vvrr=896(%rsp)
movq %r11,896(%rsp)

# qhasm:   inplace stack_uuss[0] = u
# asm 1: movq <u=int64#7,<stack_uuss=stack256#24
# asm 2: movq <u=%rax,<stack_uuss=864(%rsp)
movq %rax,864(%rsp)

# qhasm:   inplace stack_uuss[2] = s
# asm 1: movq <s=int64#10,<stack_uuss=stack256#24
# asm 2: movq <s=%r12,<stack_uuss=880(%rsp)
movq %r12,880(%rsp)
...
# asm 2: movq <stack_vvrr=912(%rsp),>t1=%rdi
movq 912(%rsp),%rdi
...
# qhasm:   stimesolds = stack_uuss[2]
# asm 1: movq <stack_uuss=stack256#24,>stimesolds=int64#4
# asm 2: movq <stack_uuss=880(%rsp),>stimesolds=%rcx
movq 880(%rsp),%rcx
...
# asm 2: movq <stack_uuss=864(%rsp),>t0=%r11
movq 864(%rsp),%r11
...
# asm 2: movq <stack_vvrr=896(%rsp),>rtimesoldv=%r13
movq 896(%rsp),%r13
...
# qhasm:   s *= stack_vvrr[2]
# asm 1: imulq <stack_vvrr=stack256#25,<s=int64#3
# asm 2: imulq <stack_vvrr=912(%rsp),<s=%rdx
imulq 912(%rsp),%rdx

# qhasm:   r *= stack_uuss[0]
# asm 1: imulq <stack_uuss=stack256#24,<r=int64#12
# asm 2: imulq <stack_uuss=864(%rsp),<r=%r14
imulq 864(%rsp),%r14
...
# qhasm: _2p63m2p33x4 = stack_2p63m2p33x4
# asm 1: vmovapd <stack_2p63m2p33x4=stack256#22,>_2p63m2p33x4=reg256#5
# asm 2: vmovapd <stack_2p63m2p33x4=800(%rsp),>_2p63m2p33x4=%ymm4
vmovapd 800(%rsp),%ymm4
...
# asm 1: vmovapd <stack_2p29x4=stack256#23,>_2p29x4=reg256#15
# asm 2: vmovapd <stack_2p29x4=832(%rsp),>_2p29x4=%ymm14
vmovapd 832(%rsp),%ymm14
...
# qhasm: _2p63m2p33x4 = stack_2p63m2p33x4
# asm 1: vmovapd <stack_2p63m2p33x4=stack256#22,>_2p63m2p33x4=reg256#11
# asm 2: vmovapd <stack_2p63m2p33x4=800(%rsp),>_2p63m2p33x4=%ymm10
vmovapd 800(%rsp),%ymm10
...
# qhasm: _2p63m2p33x4 = stack_2p63m2p33x4
# asm 1: vmovapd <stack_2p63m2p33x4=stack256#22,>_2p63m2p33x4=reg256#14
# asm 2: vmovapd <stack_2p63m2p33x4=800(%rsp),>_2p63m2p33x4=%ymm13
vmovapd 800(%rsp),%ymm13
...
# asm 1: vmovapd <out6=reg256#9,>stack_FVGS3=stack256#5
# asm 2: vmovapd <out6=%ymm8,>stack_FVGS3=256(%rsp)
vmovapd %ymm8,256(%rsp)
...
# asm 1: vmovapd <out7=reg256#4,>stack_FVGS4=stack256#6
# asm 2: vmovapd <out7=%ymm3,>stack_FVGS4=288(%rsp)
vmovapd %ymm3,288(%rsp)
...
# asm 1: vmovapd <out8=reg256#9,>stack_FVGS5=stack256#1
# asm 2: vmovapd <out8=%ymm8,>stack_FVGS5=128(%rsp)
...
# qhasm: _2p33x4 = stack_2p33x4
# asm 1: vmovapd <stack_2p33x4=stack256#20,>_2p33x4=reg256#2
# asm 2: vmovapd <stack_2p33x4=736(%rsp),>_2p33x4=%ymm1
vmovapd 736(%rsp),%ymm1
...
# qhasm: z = stack_FVGS8[1]
# asm 1: movq <stack_FVGS8=stack256#8,>z=int64#1
# asm 2: movq <stack_FVGS8=360(%rsp),>z=%rdi
movq 360(%rsp),%rdi
...
# asm 1: andq <stack_mod0=stack256#11,<h=int64#4
# asm 2: andq <stack_mod0=448(%rsp),<h=%rcx
andq 448(%rsp),%rcx
...
# asm 1: andq <stack_mod1=stack256#12,<h=int64#5
# asm 2: andq <stack_mod1=480(%rsp),<h=%r8
andq 480(%rsp),%r8
...
# asm 1: andq <stack_mod2=stack256#13,<h=int64#5
# asm 2: andq <stack_mod2=512(%rsp),<h=%r8
andq 512(%rsp),%r8
...
# asm 1: movq <stack_FVGS3=stack256#5,>t3=int64#3
# asm 2: movq <stack_FVGS3=264(%rsp),>t3=%rdx
movq 264(%rsp),%rdx
...
# asm 1: andq <stack_mod3=stack256#14,<h=int64#4
# asm 2: andq <stack_mod3=544(%rsp),<h=%rcx
andq 544(%rsp),%rcx
...
# asm 1: movq <stack_FVGS4=stack256#6,>t4=int64#3
# asm 2: movq <stack_FVGS4=296(%rsp),>t4=%rdx
movq 296(%rsp),%rdx
...
# asm 1: andq <stack_mod4=stack256#15,<h=int64#4
# asm 2: andq <stack_mod4=576(%rsp),<h=%rcx
andq 576(%rsp),%rcx
...
# asm 1: movq <stack_FVGS5=stack256#1,>t5=int64#3
# asm 2: movq <stack_FVGS5=136(%rsp),>t5=%rdx
movq 136(%rsp),%rdx
...
# asm 1: andq <stack_mod5=stack256#16,<h=int64#5
# asm 2: andq <stack_mod5=608(%rsp),<h=%r8
andq 608(%rsp),%r8
...
# asm 1: andq <stack_mod6=stack256#17,<h=int64#5
# asm 2: andq <stack_mod6=640(%rsp),<h=%r8
andq 640(%rsp),%r8
...
# asm 1: movq <stack_FVGS7=stack256#9,>t7=int64#3
# asm 2: movq <stack_FVGS7=392(%rsp),>t7=%rdx
movq 392(%rsp),%rdx
...
# asm 1: andq <stack_mod7=stack256#18,<h=int64#4
# asm 2: andq <stack_mod7=672(%rsp),<h=%rcx
andq 672(%rsp),%rcx
...
# asm 1: movq <stack_FVGS8=stack256#8,>t8=int64#3
# asm 2: movq <stack_FVGS8=360(%rsp),>t8=%rdx
movq 360(%rsp),%rdx
...
# asm 1: andq <stack_mod8=stack256#19,<h=int64#1
# asm 2: andq <stack_mod8=704(%rsp),<h=%rdi
andq 704(%rsp),%rdi

# qhasm: t8 += h
# asm 1: add  <h=int64#1,<t8=int64#3
# asm 2: add  <h=%rdi,<t8=%rdx
add  %rdi,%rdx
