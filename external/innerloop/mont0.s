...
# asm 2: movq <input_1=%rsi,>stack_out=768(%rsp)
movq %rsi,768(%rsp)
...
# asm 2: movq <caller_r11=%r11,>stack_r11=776(%rsp)
movq %r11,776(%rsp)
...
# asm 2: movq <caller_r12=%r12,>stack_r12=784(%rsp)
movq %r12,784(%rsp)
...
# asm 2: movq <caller_r13=%r13,>stack_r13=792(%rsp)
movq %r13,792(%rsp)
...
# asm 2: movq <caller_r14=%r14,>stack_r14=800(%rsp)
movq %r14,800(%rsp)
...
# asm 2: movq <caller_r15=%r15,>stack_r15=808(%rsp)
movq %r15,808(%rsp)
...
# asm 2: movq <caller_rbx=%rbx,>stack_rbx=816(%rsp)
movq %rbx,816(%rsp)
...
# asm 2: movq <caller_rbp=%rbp,>stack_rbp=824(%rsp)
movq %rbp,824(%rsp)
...
# asm 2: movq <minv=%rdi,>stack_minv=832(%rsp)
movq %rdi,832(%rsp)
...
# asm 2: movq <_m2p20=%r8,>stack_m2p20=840(%rsp)
movq %r8,840(%rsp)
...
# asm 2: movq <_2p20=%rax,>stack_2p20=848(%rsp)
movq %rax,848(%rsp)
...
# asm 2: movq <_m2p41=%rax,>stack_m2p41=856(%rsp)
movq %rax,856(%rsp)
...
# asm 2: movq <_m2p62=%rax,>stack_m2p62=864(%rsp)
movq %rax,864(%rsp)
...
# asm 2: movq <_2p20a2p41=%rax,>stack_2p20a2p41=872(%rsp)
movq %rax,872(%rsp)
...
# asm 2: vpbroadcastq <stack_minv=832(%rsp),>minvx4=%ymm9
vpbroadcastq 832(%rsp),%ymm9
...
# asm 2: addq <stack_m2p41=856(%rsp),<fuv=%rdx
addq 856(%rsp),%rdx

# qhasm:   grs += stack_m2p62
# asm 1: addq <stack_m2p62=stack64#13,<grs=int64#6
# asm 2: addq <stack_m2p62=864(%rsp),<grs=%r9
addq 864(%rsp),%r9
...
# asm 2: movq <stack_2p20a2p41=872(%rsp),>_2p20a2p41=%rax
movq 872(%rsp),%rax
...
# asm 2: movq <stack_2p20=848(%rsp),>_2p20=%r13
movq 848(%rsp),%r13
...
# asm 1: movq <v=int64#7,<stack_vvrr=stack256#24
# asm 2: movq <v=%rax,<stack_vvrr=736(%rsp)
movq %rax,736(%rsp)

# qhasm:   inplace stack_uuss[0] = u
# asm 1: movq <u=int64#3,<stack_uuss=stack256#23
# asm 2: movq <u=%rdx,<stack_uuss=704(%rsp)
movq %rdx,704(%rsp)

# qhasm:   inplace stack_uuss[2] = s
# asm 1: movq <s=int64#9,<stack_uuss=stack256#23
# asm 2: movq <s=%r11,<stack_uuss=720(%rsp)
movq %r11,720(%rsp)

# qhasm:   inplace stack_vvrr[2] = r
# asm 1: movq <r=int64#6,<stack_vvrr=stack256#24
# asm 2: movq <r=%r9,<stack_vvrr=752(%rsp)
movq %r9,752(%rsp)
...
# asm 2: addq <stack_m2p41=856(%rsp),<fuv=%rax
addq 856(%rsp),%rax
...
# asm 2: movq <stack_2p20a2p41=872(%rsp),>_2p20a2p41=%r11
movq 872(%rsp),%r11
...
# asm 2: movq <stack_2p20=848(%rsp),>_2p20=%r14
movq 848(%rsp),%r14
...
# asm 1: movq <stack_uuss=stack256#23,>t0=int64#11
# asm 2: movq <stack_uuss=704(%rsp),>t0=%r13
movq 704(%rsp),%r13
...
# asm 1: movq <stack_vvrr=stack256#24,>t1=int64#12
# asm 2: movq <stack_vvrr=752(%rsp),>t1=%r14
movq 752(%rsp),%r14
...
# asm 1: movq <stack_vvrr=stack256#24,>rtimesoldv=int64#13
# asm 2: movq <stack_vvrr=736(%rsp),>rtimesoldv=%r15
movq 736(%rsp),%r15
...
# asm 1: movq <stack_uuss=stack256#23,>stimesolds=int64#14
# asm 2: movq <stack_uuss=720(%rsp),>stimesolds=%rbx
movq 720(%rsp),%rbx
...
# asm 1: imulq <stack_uuss=stack256#23,<r=int64#6
# asm 2: imulq <stack_uuss=704(%rsp),<r=%r9
imulq 704(%rsp),%r9

# qhasm:   s *= stack_vvrr[2]
# asm 1: imulq <stack_vvrr=stack256#24,<s=int64#10
# asm 2: imulq <stack_vvrr=752(%rsp),<s=%r12
imulq 752(%rsp),%r12
...
# qhasm:   inplace stack_vvrr[0] = v
# asm 1: movq <v=int64#9,<stack_vvrr=stack256#24
# asm 2: movq <v=%r11,<stack_vvrr=736(%rsp)
movq %r11,736(%rsp)

# qhasm:   inplace stack_uuss[0] = u
# asm 1: movq <u=int64#7,<stack_uuss=stack256#23
# asm 2: movq <u=%rax,<stack_uuss=704(%rsp)
movq %rax,704(%rsp)

# qhasm:   inplace stack_uuss[2] = s
# asm 1: movq <s=int64#10,<stack_uuss=stack256#23
# asm 2: movq <s=%r12,<stack_uuss=720(%rsp)
movq %r12,720(%rsp)
...
# asm 2: movq <stack_2p20a2p41=872(%rsp),>_2p20a2p41=%rdi
movq 872(%rsp),%rdi
...
# qhasm:   t1 = stack_vvrr[2]
# asm 1: movq <stack_vvrr=stack256#24,>t1=int64#1
# asm 2: movq <stack_vvrr=752(%rsp),>t1=%rdi
movq 752(%rsp),%rdi
...
# qhasm:   stimesolds = stack_uuss[2]
# asm 1: movq <stack_uuss=stack256#23,>stimesolds=int64#3
# asm 2: movq <stack_uuss=720(%rsp),>stimesolds=%rdx
movq 720(%rsp),%rdx
...
# asm 2: movq <stack_2p20=848(%rsp),>_2p20=%r11
movq 848(%rsp),%r11
...
# qhasm:   t0 = stack_uuss[0]
# asm 1: movq <stack_uuss=stack256#23,>t0=int64#9
# asm 2: movq <stack_uuss=704(%rsp),>t0=%r11
movq 704(%rsp),%r11
...
# qhasm:   rtimesoldv = stack_vvrr[0]
# asm 1: movq <stack_vvrr=stack256#24,>rtimesoldv=int64#11
# asm 2: movq <stack_vvrr=736(%rsp),>rtimesoldv=%r13
movq 736(%rsp),%r13
...
# qhasm:   s *= stack_vvrr[2]
# asm 1: imulq <stack_vvrr=stack256#24,<s=int64#2
# asm 2: imulq <stack_vvrr=752(%rsp),<s=%rsi
imulq 752(%rsp),%rsi

# qhasm:   r *= stack_uuss[0]
# asm 1: imulq <stack_uuss=stack256#23,<r=int64#12
# asm 2: imulq <stack_uuss=704(%rsp),<r=%r14
imulq 704(%rsp),%r14
...
# asm 1: movq <stack_FVGS0=stack256#3,>t0=int64#1
# asm 2: movq <stack_FVGS0=64(%rsp),>t0=%rdi
movq 64(%rsp),%rdi

# qhasm:   t1 = stack_FVGS1[0]
# asm 1: movq <stack_FVGS1=stack256#5,>t1=int64#2
# asm 2: movq <stack_FVGS1=128(%rsp),>t1=%rsi
movq 128(%rsp),%rsi
...
# asm 1: movq <stack_FVGS0=stack256#3,>t0=int64#2
# asm 2: movq <stack_FVGS0=80(%rsp),>t0=%rsi
movq 80(%rsp),%rsi

# qhasm:   t1 = stack_FVGS1[2]
# asm 1: movq <stack_FVGS1=stack256#5,>t1=int64#3
# asm 2: movq <stack_FVGS1=144(%rsp),>t1=%rdx
movq 144(%rsp),%rdx
...
# asm 1: movq <stack_FVGS2=stack256#7,>t0=int64#2
# asm 2: movq <stack_FVGS2=192(%rsp),>t0=%rsi
movq 192(%rsp),%rsi

# qhasm:   t1 = stack_FVGS3[0]
# asm 1: movq <stack_FVGS3=stack256#9,>t1=int64#3
...
# asm 1: movq <stack_FVGS2=stack256#7,>t0=int64#3
# asm 2: movq <stack_FVGS2=208(%rsp),>t0=%rdx
movq 208(%rsp),%rdx

# qhasm:   t1 = stack_FVGS3[2]
# asm 1: movq <stack_FVGS3=stack256#9,>t1=int64#13
...
# asm 2: movq <stack_out=768(%rsp),>t2=%rdi
movq 768(%rsp),%rdi
