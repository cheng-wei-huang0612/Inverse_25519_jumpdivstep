...
intab256 = ["_2p30m1","_2p33","_2p63","_2p63m2p33","_2p29","_prime"]
...
print("# start with a Montgomery reduction then a conditional sub of p")
print("minv = mem64[ table + %d]" % (32*(len(intab256)+nlimbs)))
print("stack_minv = minv")
print("minv *= a0")
##non-broadwell code
#print("h = 0")
#print("rax = mem64[ table + %2d ]" % (32*len(intab256)-32))
#print("(uint128) rdx rax = rax * minv")
#print("t0 = rax")
#print("t1 = rdx")
#print("rax = mem64[ table + %2d ]" % (32*len(intab256)-16))
#print("(uint128) rdx rax = rax * minv")
#print("t2 = rax")
#print("t3 = rdx")
#print("carry? a0 += t0")
#print("carry? a1 += t1 + carry")
#print("carry? a2 += t2 + carry")
#print("carry? a3 += t3 + carry")
#print("        h +=  0 + carry")
#print("rax = mem64[ table + %2d ]" % (32*len(intab256)-24))
#print("(uint128) rdx rax = rax * minv")
#print("t0 = rax")
#print("t1 = rdx")
#print("rax = mem64[ table + %2d ]" % (32*len(intab256)- 8))
#print("(uint128) rdx rax = rax * minv")
#print("t2 = rax")
#print("t3 = rdx")
#print("carry? t0 += a1")
#print("carry? t1 += a2 + carry")
#print("carry? t2 += a3 + carry")
#print("       t3 +=  h + carry")
#print('''
#a0 = t0
#a1 = t1
...
#a3 = t3
#''')
#print("carry? a0 -= mem64[ table + %2d ]"         % (32*len(intab256)-32))
#print("carry? a1 -= mem64[ table + %2d ] - carry" % (32*len(intab256)-24))
#print("carry? a2 -= mem64[ table + %2d ] - carry" % (32*len(intab256)-16))
#print("carry? a3 -= mem64[ table + %2d ] - carry" % (32*len(intab256)- 8))
#print('''
#a0 = t0 if carry
#a1 = t1 if carry
#a2 = t2 if carry
#a3 = t3 if carry
#''')
print("(uint128) t2 t1 = minv * mem64[ table + %2d ]" % (32*len(intab256)-24))
print("(uint128)  h t3 = minv * mem64[ table + %2d ]" % (32*len(intab256)- 8))
print("carry? a1 += t1")
print("carry? a2 += t2 + carry")
print("carry? a3 += t3 + carry")
print("       h  +=  0 + carry")
print("(uint128) t1 t0 = minv * mem64[ table + %2d ]" % (32*len(intab256)-32))
print("(uint128) t3 t2 = minv * mem64[ table + %2d ]" % (32*len(intab256)-16))
print("carry? t0 += a0")
print("carry? t1 += a1 + carry")
print("carry? t2 += a2 + carry")
print("carry? t3 += a3 + carry")
print("        h +=  0 + carry")
print("# cannot carry because it is less than (2^256-1)*2^64")
print('''
a0 = t1
a1 = t2
a2 = t3
...
''')
print('''
# now a0 ... a3 should be reduced mod p
...
print("d1 = mem256[ table + %d]" % (32*(len(intab256)+nlimbs-1)))
#print("d0 = 4x d1[0]")
...
for i in range(nlimbs) :
    #print("d1 = 4x mem64[ table + %3d ]"% (32*(len(intab256)+i)) )
...
print("# now V is between +- p")

print("a%d = stack_FVGS%d[1]" % (nlimbs-1,nlimbs-1))
print("t0 = a%d" % (nlimbs-1))
print("(int64) t0 >>= 63")
print("t1 = stack_mod%d[0]" % (nlimbs-1))
print("t1 &= t0")
print("a%d += t1" % (nlimbs-1))

for i in range(nlimbs-1) :
    print("a%d = stack_FVGS%d[1]" % (i,i))
    print("t1 = stack_mod%d[0]" % (i))
    print("t1 &= t0\na%d += t1" % (i))
