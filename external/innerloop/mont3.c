...
/* This is the NIST-P256 curve prime (Solinas Prime) */
static const __attribute__((aligned(32)))
int64_t tabl3[64]={0x3FFFFFFFLL, 0x3FFFFFFFLL, 0x3FFFFFFFLL, 0x3FFFFFFFLL,
		   ...
		   0xffffffffffffffffLL, 0x00000000ffffffffLL,
		   0x0000000000000000LL, 0xffffffff00000001LL,
		   0x3fffffffLL, 0LL,0LL, 0LL, //  2016039LL,  
		   0x3fffffffLL, 0LL,0LL, 1LL, //  36601223LL, 
		   0x3fffffffLL, 0LL,0LL, 0LL, //  746318872LL,
		   0x0000003fLL, 0LL,0LL, 0LL, //  581158686LL,
		   0x00000000LL, 0LL,0LL, 0LL, //  1073741714LL,
		   0x00000000LL, 0LL,0LL, 0LL, //  1073741823LL,
		   0x00001000LL, 0LL,0LL, 0LL, //  1073741823LL,
		   0x3fffc000LL, 0LL,0LL, 0LL, //  826212351LL,
		   0x0000ffffLL, 0LL,0LL, 0LL, //  22050LL,	   
		   1LL, 0LL, 0LL, 0LL};

/* This is the NIST-P256 order prime */
static const __attribute__((aligned(32)))
int64_t tabl2[64]={0x3FFFFFFFLL, 0x3FFFFFFFLL, 0x3FFFFFFFLL, 0x3FFFFFFFLL,
		   0x200000000LL, 0x200000000LL, 0x200000000LL, 0x200000000LL,
		   0x8000000000000000LL, 0x8000000000000000LL,
		   0x8000000000000000LL, 0x8000000000000000LL, 
		   0X7FFFFFFE00000000LL, 0X7FFFFFFE00000000LL,
		   0X7FFFFFFE00000000LL, 0X7FFFFFFE00000000LL,
		   0x20000000LL, 0x20000000LL, 0x20000000LL, 0x20000000LL,
		   0xf3b9cac2fc632551LL, 0xbce6faada7179e84LL,
		   0xffffffffffffffffLL, 0xffffffff00000000LL,
		   0x3c632551LL, 0LL,0LL, 0LL, //  2016039LL,  
		   0x0ee72b0bLL, 0LL,0LL, 1LL, //  36601223LL, 
		   0x3179e84fLL, 0LL,0LL, 0LL, //  746318872LL,
		   0x39beab69LL, 0LL,0LL, 0LL, //  581158686LL,
		   0x3fffffbcLL, 0LL,0LL, 0LL, //  1073741714LL,
		   0x3fffffffLL, 0LL,0LL, 0LL, //  1073741823LL,
		   0x00000fffLL, 0LL,0LL, 0LL, //  1073741823LL,
		   0x3fffc000LL, 0LL,0LL, 0LL, //  826212351LL,
		   0x0000ffffLL, 0LL,0LL, 0LL, //  22050LL,	   
		   14758798090332847183LL, 0LL, 0LL, 0LL};


/* This is the Bitcoin curve order prime */
static const __attribute__((aligned(32)))
int64_t tabl1[64]={0x3FFFFFFFLL, 0x3FFFFFFFLL, 0x3FFFFFFFLL, 0x3FFFFFFFLL,
		   0x200000000LL, 0x200000000LL, 0x200000000LL, 0x200000000LL,
		   0x8000000000000000LL, 0x8000000000000000LL,
		   0x8000000000000000LL, 0x8000000000000000LL, 
		   0X7FFFFFFE00000000LL, 0X7FFFFFFE00000000LL,
		   0X7FFFFFFE00000000LL, 0X7FFFFFFE00000000LL,
		   0x20000000LL, 0x20000000LL, 0x20000000LL, 0x20000000LL,
		   0xbfd25e8cd0364141LL, 0xbaaedce6af48a03bLL,
		   0xfffffffffffffffeLL, 0xffffffffffffffffLL,
		   271991105LL, 0LL,0LL, 0LL, //  2016039LL,  
		   1061780019LL,0LL,0LL, 1LL, //  36601223LL, 
...
/* This is the usual "Bitcoin prime" */
static const __attribute__((aligned(32)))
int64_t table[64]={0x3FFFFFFFLL, 0x3FFFFFFFLL, 0x3FFFFFFFLL, 0x3FFFFFFFLL,
		   ...
		   0X7FFFFFFE00000000LL, 0X7FFFFFFE00000000LL,
		   0x20000000LL, 0x20000000LL, 0x20000000LL, 0x20000000LL, 
		   0xfffffffefffffc2fLL ,0xffffffffffffffffLL,
		   0xffffffffffffffffLL, 0xffffffffffffffffLL,
		   1073740847LL,0LL,0LL, 0LL, //  2016039LL,  
		   1073741819LL,0LL,0LL, 1LL, //  36601223LL, 
		   1073741823LL,0LL,0LL, 0LL, //  746318872LL,
		   1073741823LL,0LL,0LL, 0LL, //  581158686LL,
		   1073741823LL,0LL,0LL, 0LL, //  1073741714LL,
		   1073741823LL,0LL,0LL, 0LL, //  1073741823LL,
		   1073741823LL,0LL,0LL, 0LL, //  1073741823LL,
		   1073741823LL,0LL,0LL, 0LL, //  826212351LL,
		   65535LL     ,0LL,0LL, 0LL, //  22050LL,	   
		   304428337LL ,304428337LL ,304428337LL ,304428337LL};


/* To set up the table for an arbitrary prime exactly 256-bit long
   ...
   (less than 200 skylake cycles) so we have decided against it. */
...
int main () {
  ...
  printf("p = 0"); 
  for (i=0; i<9; i++) printf("%+lld * 2**(%d)", table[24+4*i], 30*i);
  printf("\n");
  ...
  for (j=0; j<250; j++) {
    ...
    */
    ...
    printf("Y=");
    for (i=0; i<4; i++) printf("+%llu * 2**(%d)", g[i], 64*i);
    printf("\n");
