...
#
# carrying in cmovp deleted here replaced by a conditional sub of p
print('''
t0 = a0
t1 = a1
t2 = a2
h  = a3
''')
print("carry? a0 -= mem64[ input_2 + %2d ]" % (32*len(intab256)-32))
print("carry? a1 -= mem64[ input_2 + %2d ] - carry" % (32*len(intab256)-24))
print("carry? a2 -= mem64[ input_2 + %2d ] - carry" % (32*len(intab256)-16))
print("carry? a3 -= mem64[ input_2 + %2d ] - carry" % (32*len(intab256)- 8))
print('''
a0 = t0 if carry
a1 = t1 if carry
a2 = t2 if carry
a3 = h  if carry
# now a0 ... a3 should be reduced mod p, but only if p > 2^255 
# this cheapo trick wouldn't work if p < 2^255
