...
# asm 2: movq <_m2p62=%rcx,>stack_m2p62=736(%rsp)
movq %rcx,736(%rsp)
...
# asm 2: movq <_2p20=%rcx,>stack_2p20=744(%rsp)
movq %rcx,744(%rsp)
...
# asm 2: movq <_m2p41=%rcx,>stack_m2p41=752(%rsp)
movq %rcx,752(%rsp)
...
# asm 1: addq <stack_m2p41=stack64#11,<fuv=int64#5
# asm 2: addq <stack_m2p41=752(%rsp),<fuv=%r8
addq 752(%rsp),%r8

# qhasm:   grs += stack_m2p62
# asm 1: addq <stack_m2p62=stack64#9,<grs=int64#6
# asm 2: addq <stack_m2p62=736(%rsp),<grs=%r9
addq 736(%rsp),%r9
...
# asm 2: addq <stack_m2p62=736(%rsp),<grs=%rax
addq 736(%rsp),%rax
...
# qhasm:   _2p20 = stack_2p20
# asm 1: movq <stack_2p20=stack64#10,>_2p20=int64#5
# asm 2: movq <stack_2p20=744(%rsp),>_2p20=%r8
movq 744(%rsp),%r8
