...
int main(){
    ...
    //mpz_set_str(mpF, "-442357494465584232994334592845894063794367687384513334427836909710584277991970871", 10);
    //mpz_set_str(mpG, "-3661128208310271021703216770528491304024322876653174195830950232681513943315393052", 10);

    //mpz_set_str(mpu, "-2170321677052849", 10);
    //mpz_set_str(mpv, "123", 10);
    //mpz_set_str(mpr, "684196370423833798", 10);
    //mpz_set_str(mps, "214374690674658530", 10);
    ...
    printf("    Given    F = [limb0 = %d, limb1 = %d, limb2 = %d, limb3 = %d \n"
           ...
           "                  limb8 = %d ]\n", 
           F.limb[0], F.limb[1], F.limb[2], F.limb[3], F.limb[4], F.limb[5], F.limb[6], F.limb[7], F.limb[8]);
    gmp_printf("               = %Zd\n",mpF);
    mpz_add(mptmp,mpF,mp2p272);
    mpz_mod(mptmp, mptmp, mp2p272);
    gmp_printf("    unsigned F = %Zd\n\n",mptmp);
    printf("    Given    G = [limb0 = %d, limb1 = %d, limb2 = %d, limb3 = %d \n"
           "                  limb4 = %d, limb5 = %d, limb6 = %d, limb7 = %d \n"
           "                  limb8 = %d ]\n", 
           G.limb[0], G.limb[1], G.limb[2], G.limb[3], G.limb[4], G.limb[5], G.limb[6], G.limb[7], G.limb[8]);
    gmp_printf("               = %Zd\n",mpG);
    mpz_add(mptmp,mpG,mp2p272);
    mpz_mod(mptmp, mptmp, mp2p272);
    ...
    printf("    asm_result_F = [limb0 = %d, limb1 = %d, limb2 = %d, limb3 = %d,\n"
        "                    limb4 = %d, limb5 = %d, limb6 = %d, limb7 = %d,\n"
        "                    limb8 = %d, limb9 = %d, limb10 = %d]\n\n",
        asm_resultF.limb[0], asm_resultF.limb[1], asm_resultF.limb[2], asm_resultF.limb[3],
        asm_resultF.limb[4], asm_resultF.limb[5], asm_resultF.limb[6], asm_resultF.limb[7],
        asm_resultF.limb[8], asm_resultF.limb[9], asm_resultF.limb[10]);
 
    gmp_printf("                 = %Zd\n\n", mpASMR);
    printf("    asm_result_F = [limb0 = %u, limb1 = %u, limb2 = %u, limb3 = %u,\n"
        "                    limb4 = %u, limb5 = %u, limb6 = %u, limb7 = %u,\n"
        "                    limb8 = %u, limb9 = %u, limb10 = %u]\n\n",
        asm_resultF.limb[0], asm_resultF.limb[1], asm_resultF.limb[2], asm_resultF.limb[3],
        asm_resultF.limb[4], asm_resultF.limb[5], asm_resultF.limb[6], asm_resultF.limb[7],
        asm_resultF.limb[8], asm_resultF.limb[9], asm_resultF.limb[10]);
    ...
    printf("    asm_result_G = [limb0 = %d, limb1 = %d, limb2 = %d, limb3 = %d,\n"
        "                    limb4 = %d, limb5 = %d, limb6 = %d, limb7 = %d,\n"
        "                    limb8 = %d, limb9 = %d, limb10 = %d]\n\n",
        asm_resultG.limb[0], asm_resultG.limb[1], asm_resultG.limb[2], asm_resultG.limb[3],
        asm_resultG.limb[4], asm_resultG.limb[5], asm_resultG.limb[6], asm_resultG.limb[7],
        asm_resultG.limb[8], asm_resultG.limb[9], asm_resultG.limb[10]);
    ...
    printf("correct_result_F = [limb0 = %d, limb1 = %d, limb2 = %d, limb3 = %d,\n"
        "                    limb4 = %d, limb5 = %d, limb6 = %d, limb7 = %d,\n"
        "                    limb8 = %d, limb9 = %d, limb10 = %d]\n\n",
        resultF.limb[0], resultF.limb[1], resultF.limb[2], resultF.limb[3],
        resultF.limb[4], resultF.limb[5], resultF.limb[6], resultF.limb[7],
        resultF.limb[8], resultF.limb[9], resultF.limb[10]);
    ...
    printf("correct_result_G = [limb0 = %d, limb1 = %d, limb2 = %d, limb3 = %d,\n"
        "                    limb4 = %d, limb5 = %d, limb6 = %d, limb7 = %d,\n"
        "                    limb8 = %d, limb9 = %d, limb10 = %d]\n\n",
        resultG.limb[0], resultG.limb[1], resultG.limb[2], resultG.limb[3],
        resultG.limb[4], resultG.limb[5], resultG.limb[6], resultG.limb[7],
        resultG.limb[8], resultG.limb[9], resultG.limb[10]);
