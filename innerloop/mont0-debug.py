...
intab256 = ["_2p30m1","_2p33","_2p63","_2p63m2p33"]
...
# input_3 = intermediate output

stack_interm = input_3
new stack_m1
stack_out = input_1
''' % (nbits))
...
print("interm = stack_interm")
print("mem64[interm + %d] = u" % (0))
print("mem64[interm + %d] = v" % (8))
print("mem64[interm + %d] = r" % (16))
print("mem64[interm + %d] = s" % (24))
...
for i in range(2,nlimbs) :
    next_fvgs(i)
    print("mem256[interm + %d] = out%d" % (32*(i-1),i))
...
print("mem256[interm + %d] = out%d" % (32*(nlimbs-1),nlimbs))
print("mem256[interm + %d] = out%d" % (32*(nlimbs),nlimbs+1))
print("interm += %d" % (32*(nlimbs+1)))
print("stack_interm = interm")
