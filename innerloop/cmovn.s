...
# asm 2: movq <_2p16=%rcx,>stack_2p16=736(%rsp)
movq %rcx,736(%rsp)
...
# asm 2: movq <_m2p32=%rcx,>stack_m2p32=752(%rsp)
movq %rcx,752(%rsp)
...
# asm 2: movq <_m2p15=%rcx,>stack_m2p15=760(%rsp)
movq %rcx,760(%rsp)
...
# asm 2: movq <_2p31=%r8,>stack_2p31=768(%rsp)
movq %r8,768(%rsp)
...
# asm 2: movq <_m2p48=%r8,>stack_m2p48=776(%rsp)
movq %r8,776(%rsp)
...
# asm 2: orq  <stack_m2p32=752(%rsp),<fuv=%r9
orq  752(%rsp),%r9

# qhasm:   grs |= stack_m2p48
# asm 1: orq  <stack_m2p48=stack64#14,<grs=int64#7
# asm 2: orq  <stack_m2p48=776(%rsp),<grs=%rax
orq  776(%rsp),%rax
...
# asm 1: cmovl <oldg=int64#9,<fuv=int64#6
# asm 2: cmovl <oldg=%r11,<fuv=%r9
cmovl %r11,%r9
...
# asm 1: cmovge <mnew=int64#11,<m=int64#2
# asm 2: cmovge <mnew=%r13,<m=%rsi
cmovge %r13,%rsi
...
# asm 2: movq <stack_2p16=736(%rsp),>_2p16=%r13
movq 736(%rsp),%r13
...
# asm 2: orq  <stack_m2p32=752(%rsp),<fuv=%rax
orq  752(%rsp),%rax

# qhasm:   grs |= stack_m2p48
# asm 1: orq  <stack_m2p48=stack64#14,<grs=int64#8
# asm 2: orq  <stack_m2p48=776(%rsp),<grs=%r10
orq  776(%rsp),%r10
...
# qhasm:   oldg = grs
# asm 1: mov  <grs=int64#8,>oldg=int64#10
# asm 2: mov  <grs=%r10,>oldg=%r12
mov  %r10,%r12

# qhasm:   h = grs + fuv
# asm 1: lea  (<grs=int64#8,<fuv=int64#7),>h=int64#11
# asm 2: lea  (<grs=%r10,<fuv=%rax),>h=%r13
lea  (%r10,%rax),%r13
...
# qhasm:   h = grs if  =
# asm 1: cmove <grs=int64#8,<h=int64#11
# asm 2: cmove <grs=%r10,<h=%r13
cmove %r10,%r13
...
# qhasm:   fuv = oldg if  signed<
# asm 1: cmovl <oldg=int64#10,<fuv=int64#7
# asm 2: cmovl <oldg=%r12,<fuv=%rax
cmovl %r12,%rax

# qhasm:   grs = h    if !signed<
# asm 1: cmovge <h=int64#11,<grs=int64#8
# asm 2: cmovge <h=%r13,<grs=%r10
cmovge %r13,%r10
...
# asm 2: movq <stack_2p16a2p32=744(%rsp),>_2p16a2p32=%r11
movq 744(%rsp),%r11
...
# asm 2: movq <stack_2p16=736(%rsp),>_2p16=%r14
movq 736(%rsp),%r14
...
# asm 2: movq <stack_2p16a2p32=744(%rsp),>_2p16a2p32=%rdi
movq 744(%rsp),%rdi
...
# asm 2: movq <stack_2p16=736(%rsp),>_2p16=%r12
movq 736(%rsp),%r12
...
# qhasm:   h = fuv + _2p16
# asm 1: lea  (<fuv=int64#7,<_2p16=int64#10),>h=int64#8
# asm 2: lea  (<fuv=%rax,<_2p16=%r12),>h=%r10
lea  (%rax,%r12),%r10

# qhasm:   (int64) h >>= 17
# asm 1: sar  $17,<h=int64#8
# asm 2: sar  $17,<h=%r10
sar  $17,%r10

# qhasm:   u = (int16) h
# asm 1: movsx <h=int64#8w,>u=int64#8
# asm 2: movsx <h=%r10w,>u=%r10
movsx %r10w,%r10
...
# qhasm:   t0 *= u
# asm 1: imul  <u=int64#8,<t0=int64#10
# asm 2: imul  <u=%r10,<t0=%r12
imul  %r10,%r12
...
# qhasm:   u *= rtimesoldv
# asm 1: imul  <rtimesoldv=int64#12,<u=int64#8
# asm 2: imul  <rtimesoldv=%r14,<u=%r10
imul  %r14,%r10

# qhasm:   rtimesoldv *= r
# asm 1: imul  <r=int64#11,<rtimesoldv=int64#12
# asm 2: imul  <r=%r13,<rtimesoldv=%r14
imul  %r13,%r14
...
# qhasm:   v += u
# asm 1: add  <u=int64#8,<v=int64#9
# asm 2: add  <u=%r10,<v=%r11
add  %r10,%r11

# qhasm:   u = t0 + t1
# asm 1: lea  (<t0=int64#10,<t1=int64#1),>u=int64#8
# asm 2: lea  (<t0=%r12,<t1=%rdi),>u=%r10
lea  (%r12,%rdi),%r10
...
# qhasm:   s = rtimesoldv + stimesolds
# asm 1: lea  (<rtimesoldv=int64#12,<stimesolds=int64#6),>s=int64#10
# asm 2: lea  (<rtimesoldv=%r14,<stimesolds=%r9),>s=%r12
lea  (%r14,%r9),%r12
