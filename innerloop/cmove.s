...
# asm 2: movq <_m2p15=%r8,>stack_m2p15=416(%rsp)
movq %r8,416(%rsp)
...
# asm 2: movq <_2p16=%r9,>stack_2p16=424(%rsp)
movq %r9,424(%rsp)
...
# asm 2: movq <_2p31=%r9,>stack_2p31=432(%rsp)
movq %r9,432(%rsp)
...
# asm 2: movq <_m2p32=%r9,>stack_m2p32=440(%rsp)
movq %r9,440(%rsp)
...
# asm 2: movq <_m2p48=%r9,>stack_m2p48=448(%rsp)
movq %r9,448(%rsp)
...
# asm 2: movq <_2p16a2p32=%r9,>stack_2p16a2p32=456(%rsp)
movq %r9,456(%rsp)
...
# asm 2: orq  <stack_m2p32=440(%rsp),<fuv=%rax
orq  440(%rsp),%rax

# qhasm:   grs |= stack_m2p48
# asm 1: orq  <stack_m2p48=stack64#13,<grs=int64#8
# asm 2: orq  <stack_m2p48=448(%rsp),<grs=%r10
orq  448(%rsp),%r10
...
# asm 2: movq <stack_2p16a2p32=456(%rsp),>_2p16a2p32=%r11
movq 456(%rsp),%r11
...
# asm 2: movq <stack_2p16=424(%rsp),>_2p16=%r14
movq 424(%rsp),%r14
...
# asm 2: movq <stack_2p16a2p32=456(%rsp),>_2p16a2p32=%rdx
movq 456(%rsp),%rdx
...
# asm 2: movq <stack_2p16=424(%rsp),>_2p16=%r12
movq 424(%rsp),%r12
...
# asm 2: movq <stack_FVGS=408(%rsp),>FVGS=%r12
movq 408(%rsp),%r12
...
# asm 1: vpmuldq <out0=reg256#9,<_inv19_2p30x4=reg256#10,>d0=reg256#11
# asm 2: vpmuldq <out0=%ymm8,<_inv19_2p30x4=%ymm9,>d0=%ymm10
vpmuldq %ymm8,%ymm9,%ymm10

# qhasm: d0 &= _2p30m1x4
# asm 1: vpand <d0=reg256#11,<_2p30m1x4=reg256#6,<d0=reg256#11
# asm 2: vpand <d0=%ymm10,<_2p30m1x4=%ymm5,<d0=%ymm10
vpand %ymm10,%ymm5,%ymm10

# qhasm: _19x4 = stack_19x4
# asm 1: vmovapd <stack_19x4=stack256#2,>_19x4=reg256#12
# asm 2: vmovapd <stack_19x4=32(%rsp),>_19x4=%ymm11
vmovapd 32(%rsp),%ymm11

# qhasm: reg256 19d0

# qhasm: 4x 19d0 = int32 d0 * int32 _19x4
# asm 1: vpmuldq <d0=reg256#11,<_19x4=reg256#12,>19d0=reg256#13
# asm 2: vpmuldq <d0=%ymm10,<_19x4=%ymm11,>19d0=%ymm12
vpmuldq %ymm10,%ymm11,%ymm12

# qhasm: 4x out0 -= 19d0
# asm 1: vpsubq <19d0=reg256#13,<out0=reg256#9,<out0=reg256#9
# asm 2: vpsubq <19d0=%ymm12,<out0=%ymm8,<out0=%ymm8
...
# asm 1: vpsllq $15,<d0=reg256#11,>out8plus2=reg256#11
# asm 2: vpsllq $15,<d0=%ymm10,>out8plus2=%ymm10
...
# asm 1: vmovupd   64(<FVGS=int64#10),>FVGS2=reg256#5
# asm 2: vmovupd   64(<FVGS=%r12),>FVGS2=%ymm4
vmovupd   64(%r12),%ymm4

# qhasm: 4x d1 = int32 out1 * int32 _inv19_2p30x4
# asm 1: vpmuldq <out1=reg256#2,<_inv19_2p30x4=reg256#10,>d1=reg256#9
# asm 2: vpmuldq <out1=%ymm1,<_inv19_2p30x4=%ymm9,>d1=%ymm8
vpmuldq %ymm1,%ymm9,%ymm8

# qhasm: d1 &= _2p30m1x4
# asm 1: vpand <d1=reg256#9,<_2p30m1x4=reg256#6,<d1=reg256#9
# asm 2: vpand <d1=%ymm8,<_2p30m1x4=%ymm5,<d1=%ymm8
vpand %ymm8,%ymm5,%ymm8

# qhasm: reg256 19d1

# qhasm: 4x 19d1 = int32 d1 * int32 _19x4
# asm 1: vpmuldq <d1=reg256#9,<_19x4=reg256#12,>19d1=reg256#10
# asm 2: vpmuldq <d1=%ymm8,<_19x4=%ymm11,>19d1=%ymm9
vpmuldq %ymm8,%ymm11,%ymm9

# qhasm: 4x out1 -= 19d1
# asm 1: vpsubq <19d1=reg256#10,<out1=reg256#2,<out1=reg256#2
# asm 2: vpsubq <19d1=%ymm9,<out1=%ymm1,<out1=%ymm1
vpsubq %ymm9,%ymm1,%ymm1

# qhasm: 4x out9 = d1 << 15
# asm 1: vpsllq $15,<d1=reg256#9,>out9=reg256#9
# asm 2: vpsllq $15,<d1=%ymm8,>out9=%ymm8
vpsllq $15,%ymm8,%ymm8
...
# asm 1: vpermq $0x4e,<FVGS2=reg256#5,>GSFV2=reg256#10
# asm 2: vpermq $0x4e,<FVGS2=%ymm4,>GSFV2=%ymm9
vpermq $0x4e,%ymm4,%ymm9

# qhasm: 4x ta = int32 uuss1 * int32 FVGS1
# asm 1: vpmuldq <uuss1=reg256#3,<FVGS1=reg256#13,>ta=reg256#12
# asm 2: vpmuldq <uuss1=%ymm2,<FVGS1=%ymm12,>ta=%ymm11
vpmuldq %ymm2,%ymm12,%ymm11
...
# asm 1: vpaddq <ta=reg256#12,<tb=reg256#13,>out2plus=reg256#12
# asm 2: vpaddq <ta=%ymm11,<tb=%ymm12,>out2plus=%ymm11
vpaddq %ymm11,%ymm12,%ymm11

# qhasm: 4x ta = int32 uuss0 * int32 FVGS2
# asm 1: vpmuldq <uuss0=reg256#7,<FVGS2=reg256#5,>ta=reg256#13
# asm 2: vpmuldq <uuss0=%ymm6,<FVGS2=%ymm4,>ta=%ymm12
vpmuldq %ymm6,%ymm4,%ymm12
...
# asm 1: vpaddq <out2=reg256#13,<out2plus=reg256#12,<out2=reg256#13
# asm 2: vpaddq <out2=%ymm12,<out2plus=%ymm11,<out2=%ymm12
...
# asm 1: vmovupd   96(<FVGS=int64#10),>FVGS3=reg256#12
# asm 2: vmovupd   96(<FVGS=%r12),>FVGS3=%ymm11
vmovupd   96(%r12),%ymm11

# qhasm: GSFV3 = FVGS3[1,0]
# asm 1: vpermq $0x4e,<FVGS3=reg256#12,>GSFV3=reg256#14
# asm 2: vpermq $0x4e,<FVGS3=%ymm11,>GSFV3=%ymm13
vpermq $0x4e,%ymm11,%ymm13
...
# asm 1: vpaddq <ta=reg256#5,<tb=reg256#10,>out3plus=reg256#5
# asm 2: vpaddq <ta=%ymm4,<tb=%ymm9,>out3plus=%ymm4
vpaddq %ymm4,%ymm9,%ymm4

# qhasm: 4x ta = int32 uuss0 * int32 FVGS3
# asm 1: vpmuldq <uuss0=reg256#7,<FVGS3=reg256#12,>ta=reg256#10
# asm 2: vpmuldq <uuss0=%ymm6,<FVGS3=%ymm11,>ta=%ymm9
vpmuldq %ymm6,%ymm11,%ymm9
...
# asm 1: vpaddq <out3=reg256#10,<out3plus=reg256#5,<out3=reg256#10
# asm 2: vpaddq <out3=%ymm9,<out3plus=%ymm4,<out3=%ymm9
...
# qhasm: 4x ta = out3 << 30
# asm 1: vpsllq $30,<out3=reg256#10,>ta=reg256#5
# asm 2: vpsllq $30,<out3=%ymm9,>ta=%ymm4
vpsllq $30,%ymm9,%ymm4

# qhasm: 4x ta += out2
# asm 1: vpaddq <ta=reg256#5,<out2=reg256#13,<ta=reg256#5
# asm 2: vpaddq <ta=%ymm4,<out2=%ymm12,<ta=%ymm4
vpaddq %ymm4,%ymm12,%ymm4

# qhasm: stack_fxgx = ta
# asm 1: vmovapd <ta=reg256#5,>stack_fxgx=stack256#1
# asm 2: vmovapd <ta=%ymm4,>stack_fxgx=0(%rsp)
vmovapd %ymm4,0(%rsp)

# qhasm: FVGS4 = mem256[ FVGS +  128 ]
# asm 1: vmovupd   128(<FVGS=int64#10),>FVGS4=reg256#5
# asm 2: vmovupd   128(<FVGS=%r12),>FVGS4=%ymm4
vmovupd   128(%r12),%ymm4

# qhasm: GSFV4 = FVGS4[1,0]
# asm 1: vpermq $0x4e,<FVGS4=reg256#5,>GSFV4=reg256#15
# asm 2: vpermq $0x4e,<FVGS4=%ymm4,>GSFV4=%ymm14
vpermq $0x4e,%ymm4,%ymm14

# qhasm: 4x ta = int32 uuss1 * int32 FVGS3
# asm 1: vpmuldq <uuss1=reg256#3,<FVGS3=reg256#12,>ta=reg256#12
# asm 2: vpmuldq <uuss1=%ymm2,<FVGS3=%ymm11,>ta=%ymm11
...
# asm 1: vpaddq <ta=reg256#12,<tb=reg256#14,>out4plus=reg256#12
# asm 2: vpaddq <ta=%ymm11,<tb=%ymm13,>out4plus=%ymm11
vpaddq %ymm11,%ymm13,%ymm11

# qhasm: 4x ta = int32 uuss0 * int32 FVGS4
# asm 1: vpmuldq <uuss0=reg256#7,<FVGS4=reg256#5,>ta=reg256#14
# asm 2: vpmuldq <uuss0=%ymm6,<FVGS4=%ymm4,>ta=%ymm13
vpmuldq %ymm6,%ymm4,%ymm13

# qhasm: 4x tb = int32 vvrr0 * int32 GSFV4
# asm 1: vpmuldq <vvrr0=reg256#8,<GSFV4=reg256#15,>tb=reg256#16
# asm 2: vpmuldq <vvrr0=%ymm7,<GSFV4=%ymm14,>tb=%ymm15
vpmuldq %ymm7,%ymm14,%ymm15

# qhasm: 4x out4 = ta + tb
# asm 1: vpaddq <ta=reg256#14,<tb=reg256#16,>out4=reg256#14
# asm 2: vpaddq <ta=%ymm13,<tb=%ymm15,>out4=%ymm13
vpaddq %ymm13,%ymm15,%ymm13

# qhasm: 4x out4 += out4plus
# asm 1: vpaddq <out4=reg256#14,<out4plus=reg256#12,<out4=reg256#14
# asm 2: vpaddq <out4=%ymm13,<out4plus=%ymm11,<out4=%ymm13
...
# asm 1: vmovupd   160(<FVGS=int64#10),>FVGS5=reg256#2
# asm 2: vmovupd   160(<FVGS=%r12),>FVGS5=%ymm1
vmovupd   160(%r12),%ymm1

# qhasm: GSFV5 = FVGS5[1,0]
# asm 1: vpermq $0x4e,<FVGS5=reg256#2,>GSFV5=reg256#10
# asm 2: vpermq $0x4e,<FVGS5=%ymm1,>GSFV5=%ymm9
vpermq $0x4e,%ymm1,%ymm9

# qhasm: 4x carryy = out4 + _2p63m2p33x4 
# asm 1: vpaddq <out4=reg256#14,<_2p63m2p33x4=reg256#1,>carryy=reg256#12
# asm 2: vpaddq <out4=%ymm13,<_2p63m2p33x4=%ymm0,>carryy=%ymm11
...
# asm 1: vpmuldq <uuss1=reg256#3,<FVGS4=reg256#5,>ta=reg256#5
# asm 2: vpmuldq <uuss1=%ymm2,<FVGS4=%ymm4,>ta=%ymm4
vpmuldq %ymm2,%ymm4,%ymm4

# qhasm: 4x tb = int32 vvrr1 * int32 GSFV4
# asm 1: vpmuldq <vvrr1=reg256#4,<GSFV4=reg256#15,>tb=reg256#15
# asm 2: vpmuldq <vvrr1=%ymm3,<GSFV4=%ymm14,>tb=%ymm14
vpmuldq %ymm3,%ymm14,%ymm14

# qhasm: 4x out5plus = ta + tb
# asm 1: vpaddq <ta=reg256#5,<tb=reg256#15,>out5plus=reg256#5
# asm 2: vpaddq <ta=%ymm4,<tb=%ymm14,>out5plus=%ymm4
vpaddq %ymm4,%ymm14,%ymm4

# qhasm: 4x ta = int32 uuss0 * int32 FVGS5
# asm 1: vpmuldq <uuss0=reg256#7,<FVGS5=reg256#2,>ta=reg256#15
# asm 2: vpmuldq <uuss0=%ymm6,<FVGS5=%ymm1,>ta=%ymm14
vpmuldq %ymm6,%ymm1,%ymm14

# qhasm: 4x tb = int32 vvrr0 * int32 GSFV5
# asm 1: vpmuldq <vvrr0=reg256#8,<GSFV5=reg256#10,>tb=reg256#16
# asm 2: vpmuldq <vvrr0=%ymm7,<GSFV5=%ymm9,>tb=%ymm15
vpmuldq %ymm7,%ymm9,%ymm15

# qhasm: 4x out5 = ta + tb
# asm 1: vpaddq <ta=reg256#15,<tb=reg256#16,>out5=reg256#15
# asm 2: vpaddq <ta=%ymm14,<tb=%ymm15,>out5=%ymm14
vpaddq %ymm14,%ymm15,%ymm14

# qhasm: 4x out5 += out5plus
# asm 1: vpaddq <out5=reg256#15,<out5plus=reg256#5,<out5=reg256#15
# asm 2: vpaddq <out5=%ymm14,<out5plus=%ymm4,<out5=%ymm14
vpaddq %ymm14,%ymm4,%ymm14

# qhasm: 4x out5 += carryy
# asm 1: vpaddq <out5=reg256#15,<carryy=reg256#12,<out5=reg256#15
# asm 2: vpaddq <out5=%ymm14,<carryy=%ymm11,<out5=%ymm14
vpaddq %ymm14,%ymm11,%ymm14

# qhasm: 4x carryy = out5 + _2p63m2p33x4 
# asm 1: vpaddq <out5=reg256#15,<_2p63m2p33x4=reg256#1,>carryy=reg256#5
# asm 2: vpaddq <out5=%ymm14,<_2p63m2p33x4=%ymm0,>carryy=%ymm4
...
# asm 1: vmovupd   192(<FVGS=int64#10),>FVGS6=reg256#12
# asm 2: vmovupd   192(<FVGS=%r12),>FVGS6=%ymm11
vmovupd   192(%r12),%ymm11

# qhasm: GSFV6 = FVGS6[1,0]
# asm 1: vpermq $0x4e,<FVGS6=reg256#12,>GSFV6=reg256#14
# asm 2: vpermq $0x4e,<FVGS6=%ymm11,>GSFV6=%ymm13
vpermq $0x4e,%ymm11,%ymm13

# qhasm: 4x ta = int32 uuss1 * int32 FVGS5
# asm 1: vpmuldq <uuss1=reg256#3,<FVGS5=reg256#2,>ta=reg256#2
# asm 2: vpmuldq <uuss1=%ymm2,<FVGS5=%ymm1,>ta=%ymm1
vpmuldq %ymm2,%ymm1,%ymm1

# qhasm: 4x tb = int32 vvrr1 * int32 GSFV5
# asm 1: vpmuldq <vvrr1=reg256#4,<GSFV5=reg256#10,>tb=reg256#10
# asm 2: vpmuldq <vvrr1=%ymm3,<GSFV5=%ymm9,>tb=%ymm9
vpmuldq %ymm3,%ymm9,%ymm9

# qhasm: 4x out6plus = ta + tb
# asm 1: vpaddq <ta=reg256#2,<tb=reg256#10,>out6plus=reg256#2
# asm 2: vpaddq <ta=%ymm1,<tb=%ymm9,>out6plus=%ymm1
vpaddq %ymm1,%ymm9,%ymm1

# qhasm: 4x ta = int32 uuss0 * int32 FVGS6
# asm 1: vpmuldq <uuss0=reg256#7,<FVGS6=reg256#12,>ta=reg256#10
# asm 2: vpmuldq <uuss0=%ymm6,<FVGS6=%ymm11,>ta=%ymm9
vpmuldq %ymm6,%ymm11,%ymm9
...
# qhasm: 4x out6 = ta + tb
# asm 1: vpaddq <ta=reg256#10,<tb=reg256#16,>out6=reg256#10
# asm 2: vpaddq <ta=%ymm9,<tb=%ymm15,>out6=%ymm9
vpaddq %ymm9,%ymm15,%ymm9

# qhasm: 4x out6 += out6plus
# asm 1: vpaddq <out6=reg256#10,<out6plus=reg256#2,<out6=reg256#10
# asm 2: vpaddq <out6=%ymm9,<out6plus=%ymm1,<out6=%ymm9
vpaddq %ymm9,%ymm1,%ymm9

# qhasm: 4x out6 += carryy
# asm 1: vpaddq <out6=reg256#10,<carryy=reg256#5,<out6=reg256#10
# asm 2: vpaddq <out6=%ymm9,<carryy=%ymm4,<out6=%ymm9
vpaddq %ymm9,%ymm4,%ymm9

# qhasm: out5 &= _2p30m1x4
# asm 1: vpand <out5=reg256#15,<_2p30m1x4=reg256#6,<out5=reg256#15
# asm 2: vpand <out5=%ymm14,<_2p30m1x4=%ymm5,<out5=%ymm14
vpand %ymm14,%ymm5,%ymm14

# qhasm: mem256[ FVGS + 96 ] = out5
# asm 1: vmovupd   <out5=reg256#15,96(<FVGS=int64#10)
# asm 2: vmovupd   <out5=%ymm14,96(<FVGS=%r12)
vmovupd   %ymm14,96(%r12)

# qhasm: reg256 carryz

# qhasm: 4x carryz = out6 + _2p63m2p33x4 
# asm 1: vpaddq <out6=reg256#10,<_2p63m2p33x4=reg256#1,>carryz=reg256#2
# asm 2: vpaddq <out6=%ymm9,<_2p63m2p33x4=%ymm0,>carryz=%ymm1
vpaddq %ymm9,%ymm0,%ymm1
...
# asm 1: vpmuldq <uuss1=reg256#3,<FVGS6=reg256#12,>ta=reg256#5
# asm 2: vpmuldq <uuss1=%ymm2,<FVGS6=%ymm11,>ta=%ymm4
vpmuldq %ymm2,%ymm11,%ymm4

# qhasm: 4x tb = int32 vvrr1 * int32 GSFV6
# asm 1: vpmuldq <vvrr1=reg256#4,<GSFV6=reg256#14,>tb=reg256#12
# asm 2: vpmuldq <vvrr1=%ymm3,<GSFV6=%ymm13,>tb=%ymm11
vpmuldq %ymm3,%ymm13,%ymm11

# qhasm: 4x out7 = ta + tb
# asm 1: vpaddq <ta=reg256#5,<tb=reg256#12,>out7=reg256#5
# asm 2: vpaddq <ta=%ymm4,<tb=%ymm11,>out7=%ymm4
vpaddq %ymm4,%ymm11,%ymm4

# qhasm: FVGS7 = mem256[ FVGS +  224 ]
# asm 1: vmovupd   224(<FVGS=int64#10),>FVGS7=reg256#12
# asm 2: vmovupd   224(<FVGS=%r12),>FVGS7=%ymm11
vmovupd   224(%r12),%ymm11

# qhasm: 4x ta = int32 uuss0 * int32 FVGS7
# asm 1: vpmuldq <uuss0=reg256#7,<FVGS7=reg256#12,>ta=reg256#14
# asm 2: vpmuldq <uuss0=%ymm6,<FVGS7=%ymm11,>ta=%ymm13
vpmuldq %ymm6,%ymm11,%ymm13

# qhasm: 4x out7 += ta
# asm 1: vpaddq <out7=reg256#5,<ta=reg256#14,<out7=reg256#5
# asm 2: vpaddq <out7=%ymm4,<ta=%ymm13,<out7=%ymm4
vpaddq %ymm4,%ymm13,%ymm4

# qhasm: GSFV7 = FVGS7[1,0]
# asm 1: vpermq $0x4e,<FVGS7=reg256#12,>GSFV7=reg256#14
# asm 2: vpermq $0x4e,<FVGS7=%ymm11,>GSFV7=%ymm13
vpermq $0x4e,%ymm11,%ymm13

# qhasm: 4x tb = int32 vvrr0 * int32 GSFV7
# asm 1: vpmuldq <vvrr0=reg256#8,<GSFV7=reg256#14,>tb=reg256#15
# asm 2: vpmuldq <vvrr0=%ymm7,<GSFV7=%ymm13,>tb=%ymm14
vpmuldq %ymm7,%ymm13,%ymm14

# qhasm: 4x out7 += tb
# asm 1: vpaddq <out7=reg256#5,<tb=reg256#15,<out7=reg256#5
# asm 2: vpaddq <out7=%ymm4,<tb=%ymm14,<out7=%ymm4
vpaddq %ymm4,%ymm14,%ymm4

# qhasm: 4x out7 += carryz
# asm 1: vpaddq <out7=reg256#5,<carryz=reg256#2,<out7=reg256#5
# asm 2: vpaddq <out7=%ymm4,<carryz=%ymm1,<out7=%ymm4
vpaddq %ymm4,%ymm1,%ymm4

# qhasm: 4x carryz = out7 + _2p63m2p33x4 
# asm 1: vpaddq <out7=reg256#5,<_2p63m2p33x4=reg256#1,>carryz=reg256#2
# asm 2: vpaddq <out7=%ymm4,<_2p63m2p33x4=%ymm0,>carryz=%ymm1
...
# asm 1: vpand <out6=reg256#10,<_2p30m1x4=reg256#6,<out6=reg256#10
# asm 2: vpand <out6=%ymm9,<_2p30m1x4=%ymm5,<out6=%ymm9
vpand %ymm9,%ymm5,%ymm9

# qhasm: mem256[ FVGS +128 ] = out6
# asm 1: vmovupd   <out6=reg256#10,128(<FVGS=int64#10)
# asm 2: vmovupd   <out6=%ymm9,128(<FVGS=%r12)
vmovupd   %ymm9,128(%r12)

# qhasm: FVGS8 = mem256[ FVGS +  256 ]
# asm 1: vmovupd   256(<FVGS=int64#10),>FVGS8=reg256#10
# asm 2: vmovupd   256(<FVGS=%r12),>FVGS8=%ymm9
vmovupd   256(%r12),%ymm9

# qhasm: GSFV8 = FVGS8[1,0]
# asm 1: vpermq $0x4e,<FVGS8=reg256#10,>GSFV8=reg256#15
# asm 2: vpermq $0x4e,<FVGS8=%ymm9,>GSFV8=%ymm14
vpermq $0x4e,%ymm9,%ymm14

# qhasm: 4x ta = int32 uuss1 * int32 FVGS7
# asm 1: vpmuldq <uuss1=reg256#3,<FVGS7=reg256#12,>ta=reg256#12
# asm 2: vpmuldq <uuss1=%ymm2,<FVGS7=%ymm11,>ta=%ymm11
vpmuldq %ymm2,%ymm11,%ymm11

# qhasm: 4x tb = int32 vvrr1 * int32 GSFV7
# asm 1: vpmuldq <vvrr1=reg256#4,<GSFV7=reg256#14,>tb=reg256#14
# asm 2: vpmuldq <vvrr1=%ymm3,<GSFV7=%ymm13,>tb=%ymm13
vpmuldq %ymm3,%ymm13,%ymm13

# qhasm: 4x out8plus = ta + tb
# asm 1: vpaddq <ta=reg256#12,<tb=reg256#14,>out8plus=reg256#12
# asm 2: vpaddq <ta=%ymm11,<tb=%ymm13,>out8plus=%ymm11
vpaddq %ymm11,%ymm13,%ymm11

# qhasm: 4x ta = int32 uuss0 * int32 FVGS8
# asm 1: vpmuldq <uuss0=reg256#7,<FVGS8=reg256#10,>ta=reg256#7
# asm 2: vpmuldq <uuss0=%ymm6,<FVGS8=%ymm9,>ta=%ymm6
vpmuldq %ymm6,%ymm9,%ymm6
...
# asm 1: vpaddq <out8=reg256#7,<out8plus=reg256#12,<out8=reg256#7
# asm 2: vpaddq <out8=%ymm6,<out8plus=%ymm11,<out8=%ymm6
vpaddq %ymm6,%ymm11,%ymm6

# qhasm: 4x out8 += out8plus2
# asm 1: vpaddq <out8=reg256#7,<out8plus2=reg256#11,<out8=reg256#7
# asm 2: vpaddq <out8=%ymm6,<out8plus2=%ymm10,<out8=%ymm6
...
# asm 1: vpand <out7=reg256#5,<_2p30m1x4=reg256#6,<out7=reg256#5
# asm 2: vpand <out7=%ymm4,<_2p30m1x4=%ymm5,<out7=%ymm4
vpand %ymm4,%ymm5,%ymm4

# qhasm: mem256[ FVGS +160 ] = out7
# asm 1: vmovupd   <out7=reg256#5,160(<FVGS=int64#10)
# asm 2: vmovupd   <out7=%ymm4,160(<FVGS=%r12)
vmovupd   %ymm4,160(%r12)
...
# asm 1: vpaddq <out9=reg256#9,<out9plus=reg256#3,<out9=reg256#9
# asm 2: vpaddq <out9=%ymm8,<out9plus=%ymm2,<out9=%ymm8
vpaddq %ymm8,%ymm2,%ymm8

# qhasm: 4x out9 += carryz
# asm 1: vpaddq <out9=reg256#9,<carryz=reg256#2,<out9=reg256#9
# asm 2: vpaddq <out9=%ymm8,<carryz=%ymm1,<out9=%ymm8
...
# asm 1: vpand <out9=reg256#9,<_2p30m1x4=reg256#6,<out9=reg256#9
# asm 2: vpand <out9=%ymm8,<_2p30m1x4=%ymm5,<out9=%ymm8
vpand %ymm8,%ymm5,%ymm8
...
# asm 1: vmovupd   <out9=reg256#9,224(<FVGS=int64#10)
# asm 2: vmovupd   <out9=%ymm8,224(<FVGS=%r12)
vmovupd   %ymm8,224(%r12)
