...
# qhasm: enter mul2x2s128_25519
.p2align 5
.global _mul2x2s128_25519
.global mul2x2s128_25519
_mul2x2s128_25519:
mul2x2s128_25519:
mov %rsp,%r11
and $31,%r11
...
# qhasm: t1 = a3
# asm 1: mov  <a3=int64#12,>t1=int64#1
# asm 2: mov  <a3=%r14,>t1=%rdi
mov  %r14,%rdi

# qhasm: (int64) t1 >>= 63
# asm 1: sar  $63,<t1=int64#1
# asm 2: sar  $63,<t1=%rdi
sar  $63,%rdi

# qhasm: t0 = -19
# asm 1: mov  $-19,>t0=int64#2
# asm 2: mov  $-19,>t0=%rsi
mov  $-19,%rsi

# qhasm: t0 &= t1
# asm 1: and  <t1=int64#1,<t0=int64#2
# asm 2: and  <t1=%rdi,<t0=%rsi
and  %rdi,%rsi

# qhasm: t3 = 9223372036854775807
# asm 1: mov  $9223372036854775807,>t3=int64#3
# asm 2: mov  $9223372036854775807,>t3=%rdx
mov  $9223372036854775807,%rdx

# qhasm: t3 &= t1
# asm 1: and  <t1=int64#1,<t3=int64#3
# asm 2: and  <t1=%rdi,<t3=%rdx
and  %rdi,%rdx

# qhasm: carry? a0 += t0
# asm 1: add  <t0=int64#2,<a0=int64#9
# asm 2: add  <t0=%rsi,<a0=%r11
add  %rsi,%r11

# qhasm: carry? a1 += t1 + carry
# asm 1: adc <t1=int64#1,<a1=int64#10
# asm 2: adc <t1=%rdi,<a1=%r12
adc %rdi,%r12

# qhasm: carry? a2 += t1 + carry
# asm 1: adc <t1=int64#1,<a2=int64#11
# asm 2: adc <t1=%rdi,<a2=%r13
adc %rdi,%r13

# qhasm: a3 += t3 + carry
# asm 1: adc <t3=int64#3,<a3=int64#12
# asm 2: adc <t3=%rdx,<a3=%r14
adc %rdx,%r14
