...
# qhasm: t1 = 32768
# asm 1: mov  $32768,>t1=int64#2
# asm 2: mov  $32768,>t1=%rsi
mov  $32768,%rsi

# qhasm: inplace stack_FVGS8[0] = t1
# asm 1: movq <t1=int64#2,<stack_FVGS8=stack256#9
# asm 2: movq <t1=%rsi,<stack_FVGS8=256(%rsp)
movq %rsi,256(%rsp)

# qhasm: t0 = 1
# asm 1: mov  $1,>t0=int64#2
# asm 2: mov  $1,>t0=%rsi
mov  $1,%rsi

# qhasm: inplace stack_FVGS0[3] = t0
# asm 1: movq <t0=int64#2,<stack_FVGS0=stack256#1
# asm 2: movq <t0=%rsi,<stack_FVGS0=24(%rsp)
movq %rsi,24(%rsp)
...
# qhasm:             _2p16 = 65536
# asm 1: mov  $65536,>_2p16=int64#5
# asm 2: mov  $65536,>_2p16=%r8
mov  $65536,%r8

# qhasm:        stack_2p16 = _2p16
# asm 1: movq <_2p16=int64#5,>stack_2p16=stack64#10
# asm 2: movq <_2p16=%r8,>stack_2p16=776(%rsp)
movq %r8,776(%rsp)
...
# asm 1: movq <_2p31=int64#5,>stack_2p31=stack64#11
# asm 2: movq <_2p31=%r8,>stack_2p31=784(%rsp)
movq %r8,784(%rsp)

# qhasm:            _m2p32 = -4294967296
# asm 1: mov  $-4294967296,>_m2p32=int64#5
# asm 2: mov  $-4294967296,>_m2p32=%r8
mov  $-4294967296,%r8

# qhasm:       stack_m2p32 = _m2p32
# asm 1: movq <_m2p32=int64#5,>stack_m2p32=stack64#12
# asm 2: movq <_m2p32=%r8,>stack_m2p32=792(%rsp)
movq %r8,792(%rsp)
...
# asm 1: movq <_m2p48=int64#5,>stack_m2p48=stack64#13
# asm 2: movq <_m2p48=%r8,>stack_m2p48=800(%rsp)
movq %r8,800(%rsp)

# qhasm:        _2p16a2p32 = 4295032832
# asm 1: mov  $4295032832,>_2p16a2p32=int64#5
# asm 2: mov  $4295032832,>_2p16a2p32=%r8
mov  $4295032832,%r8

# qhasm:   stack_2p16a2p32 = _2p16a2p32
# asm 1: movq <_2p16a2p32=int64#5,>stack_2p16a2p32=stack64#14
# asm 2: movq <_2p16a2p32=%r8,>stack_2p16a2p32=808(%rsp)
movq %r8,808(%rsp)
...
# qhasm:   grs = g & ~ _m2p15
# asm 1: andn  <g=int64#6,<_m2p15=int64#4,>grs=int64#8
# asm 2: andn  <g=%r9,<_m2p15=%rcx,>grs=%r10
andn  %r9,%rcx,%r10

# qhasm:   fuv |= stack_m2p32
# asm 1: orq  <stack_m2p32=stack64#12,<fuv=int64#7
# asm 2: orq  <stack_m2p32=792(%rsp),<fuv=%rax
orq  792(%rsp),%rax

# qhasm:   grs |= stack_m2p48
# asm 1: orq  <stack_m2p48=stack64#13,<grs=int64#8
# asm 2: orq  <stack_m2p48=800(%rsp),<grs=%r10
orq  800(%rsp),%r10
...
# asm 2: movq <stack_2p16a2p32=808(%rsp),>_2p16a2p32=%r11
movq 808(%rsp),%r11
...
# qhasm:   t2 = g
# asm 1: mov  <g=int64#6,>t2=int64#11
# asm 2: mov  <g=%r9,>t2=%r13
mov  %r9,%r13

# qhasm:   g *= s  
# asm 1: imul  <s=int64#10,<g=int64#6
# asm 2: imul  <s=%r12,<g=%r9
imul  %r12,%r9
...
# qhasm:        g += rax
# asm 1: add  <rax=int64#13,<g=int64#6
# asm 2: add  <rax=%r15,<g=%r9
add  %r15,%r9
...
# qhasm:        (int64) g >>= 15
# asm 1: sar  $15,<g=int64#6
# asm 2: sar  $15,<g=%r9
sar  $15,%r9

# qhasm:   =? loop - 3  
# asm 1: cmp  $3,<loop=int64#5
# asm 2: cmp  $3,<loop=%r8
cmp  $3,%r8
# comment:fp stack unchanged by jump
...
# qhasm:   s = grs + _2p16a2p32
# asm 1: lea  (<grs=int64#8,<_2p16a2p32=int64#1),>s=int64#5
# asm 2: lea  (<grs=%r10,<_2p16a2p32=%rdi),>s=%r8
lea  (%r10,%rdi),%r8

# qhasm:   (int64) s >>= 33
# asm 1: sar  $33,<s=int64#5
# asm 2: sar  $33,<s=%r8
sar  $33,%r8

# qhasm:   v = fuv + _2p16a2p32
# asm 1: lea  (<fuv=int64#7,<_2p16a2p32=int64#1),>v=int64#1
# asm 2: lea  (<fuv=%rax,<_2p16a2p32=%rdi),>v=%rdi
lea  (%rax,%rdi),%rdi

# qhasm:   (int64) v >>= 33
# asm 1: sar  $33,<v=int64#1
# asm 2: sar  $33,<v=%rdi
sar  $33,%rdi

# qhasm:   t1 = stack_vvrr[2]
# asm 1: movq <stack_vvrr=stack256#20,>t1=int64#6
# asm 2: movq <stack_vvrr=624(%rsp),>t1=%r9
movq 624(%rsp),%r9

# qhasm:   t1 *= v
# asm 1: imul  <v=int64#1,<t1=int64#6
# asm 2: imul  <v=%rdi,<t1=%r9
imul  %rdi,%r9

# qhasm:   stimesolds = stack_uuss[2]
# asm 1: movq <stack_uuss=stack256#19,>stimesolds=int64#9
# asm 2: movq <stack_uuss=592(%rsp),>stimesolds=%r11
movq 592(%rsp),%r11

# qhasm:   v *= stimesolds
# asm 1: imul  <stimesolds=int64#9,<v=int64#1
# asm 2: imul  <stimesolds=%r11,<v=%rdi
imul  %r11,%rdi

# qhasm:   stimesolds *= s
# asm 1: imul  <s=int64#5,<stimesolds=int64#9
# asm 2: imul  <s=%r8,<stimesolds=%r11
imul  %r8,%r11

# qhasm:   _2p16 = stack_2p16
# asm 1: movq <stack_2p16=stack64#10,>_2p16=int64#10
# asm 2: movq <stack_2p16=776(%rsp),>_2p16=%r12
movq 776(%rsp),%r12
...
# qhasm:   t0 *= u
# asm 1: imul  <u=int64#7,<t0=int64#10
# asm 2: imul  <u=%rax,<t0=%r12
imul  %rax,%r12

# qhasm:   rtimesoldv = stack_vvrr[0]
# asm 1: movq <stack_vvrr=stack256#20,>rtimesoldv=int64#11
# asm 2: movq <stack_vvrr=608(%rsp),>rtimesoldv=%r13
movq 608(%rsp),%r13

# qhasm:   u *= rtimesoldv
# asm 1: imul  <rtimesoldv=int64#11,<u=int64#7
# asm 2: imul  <rtimesoldv=%r13,<u=%rax
imul  %r13,%rax

# qhasm:   rtimesoldv *= r
# asm 1: imul  <r=int64#8,<rtimesoldv=int64#11
# asm 2: imul  <r=%r10,<rtimesoldv=%r13
imul  %r10,%r13

# qhasm:   s *= stack_vvrr[2]
# asm 1: imulq <stack_vvrr=stack256#20,<s=int64#5
# asm 2: imulq <stack_vvrr=624(%rsp),<s=%r8
imulq 624(%rsp),%r8
...
# qhasm:   v += u
# asm 1: add  <u=int64#7,<v=int64#1
# asm 2: add  <u=%rax,<v=%rdi
add  %rax,%rdi

# qhasm:   u = t0 + t1
# asm 1: lea  (<t0=int64#10,<t1=int64#6),>u=int64#6
# asm 2: lea  (<t0=%r12,<t1=%r9),>u=%r9
lea  (%r12,%r9),%r9

# qhasm:   r += s
# asm 1: add  <s=int64#5,<r=int64#8
# asm 2: add  <s=%r8,<r=%r10
add  %r8,%r10

# qhasm:   s = rtimesoldv + stimesolds
# asm 1: lea  (<rtimesoldv=int64#11,<stimesolds=int64#9),>s=int64#5
# asm 2: lea  (<rtimesoldv=%r13,<stimesolds=%r11),>s=%r8
lea  (%r13,%r11),%r8
...
# asm 1: vpinsrq $0x0,<v=int64#1,<vvrr=reg256#4%128,<vvrr=reg256#4%128
# asm 2: vpinsrq $0x0,<v=%rdi,<vvrr=%xmm3,<vvrr=%xmm3
vpinsrq $0x0,%rdi,%xmm3,%xmm3

# qhasm: uuss = uuss[0],s,0,0
# asm 1: vpinsrq $0x1,<s=int64#5,<uuss=reg256#3%128,<uuss=reg256#3%128
# asm 2: vpinsrq $0x1,<s=%r8,<uuss=%xmm2,<uuss=%xmm2
vpinsrq $0x1,%r8,%xmm2,%xmm2
...
# asm 1: movq <stack_FVGS0=stack256#1,>a0=int64#1
# asm 2: movq <stack_FVGS0=8(%rsp),>a0=%rdi
movq 8(%rsp),%rdi
...
# asm 1: movq <stack_FVGS3=stack256#4,>a3=int64#4
# asm 2: movq <stack_FVGS3=104(%rsp),>a3=%rcx
movq 104(%rsp),%rcx

# qhasm: a4 = stack_FVGS4[1]
# asm 1: movq <stack_FVGS4=stack256#5,>a4=int64#5
# asm 2: movq <stack_FVGS4=136(%rsp),>a4=%r8
movq 136(%rsp),%r8

# qhasm: a5 = stack_FVGS5[1]
# asm 1: movq <stack_FVGS5=stack256#6,>a5=int64#6
# asm 2: movq <stack_FVGS5=168(%rsp),>a5=%r9
movq 168(%rsp),%r9

# qhasm: a6 = stack_FVGS6[1]
# asm 1: movq <stack_FVGS6=stack256#7,>a6=int64#7
# asm 2: movq <stack_FVGS6=200(%rsp),>a6=%rax
movq 200(%rsp),%rax

# qhasm: a7 = stack_FVGS7[1]
# asm 1: movq <stack_FVGS7=stack256#8,>a7=int64#8
# asm 2: movq <stack_FVGS7=232(%rsp),>a7=%r10
movq 232(%rsp),%r10

# qhasm: a8 = stack_FVGS8[1]
# asm 1: movq <stack_FVGS8=stack256#9,>a8=int64#9
# asm 2: movq <stack_FVGS8=264(%rsp),>a8=%r11
movq 264(%rsp),%r11
...
# asm 2: movq <stack_out=760(%rsp),>t2=%r13
movq 760(%rsp),%r13

# qhasm: rax = stack_FVGS0[0]
# asm 1: movq <stack_FVGS0=stack256#1,>rax=int64#12
# asm 2: movq <stack_FVGS0=0(%rsp),>rax=%r14
movq 0(%rsp),%r14
