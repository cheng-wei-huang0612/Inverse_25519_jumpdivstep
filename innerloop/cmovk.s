...
# qhasm: g = a0 & ~ t0
# asm 1: andn  <a0=int64#2,<t0=int64#6,>g=int64#8
# asm 2: andn  <a0=%rsi,<t0=%r9,>g=%r10
andn  %rsi,%r9,%r10

# qhasm: g0 = a1
# asm 1: mov  <a1=int64#4,>g0=int64#7
# asm 2: mov  <a1=%rcx,>g0=%rax
mov  %rcx,%rax

# qhasm: g0 = (g0.a0) << 4
# asm 1: shld $4,<a0=int64#2,<g0=int64#7
# asm 2: shld $4,<a0=%rsi,<g0=%rax
shld $4,%rsi,%rax

# qhasm: g0 = g0 & ~ t0
# asm 1: andn  <g0=int64#7,<t0=int64#6,>g0=int64#6
# asm 2: andn  <g0=%rax,<t0=%r9,>g0=%r9
andn  %rax,%r9,%r9

# qhasm: d1 = mem256[ input_2 + 288 ]
# asm 1: vmovupd   288(<input_2=int64#3),>d1=reg256#2
# asm 2: vmovupd   288(<input_2=%rdx),>d1=%ymm1
vmovupd   288(%rdx),%ymm1

# qhasm: stack_FVGS0 = d1
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS0=stack256#2
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS0=32(%rsp)
vmovapd %ymm1,32(%rsp)
...
# asm 1: vmovupd   320(<input_2=int64#3),>d1=reg256#2
# asm 2: vmovupd   320(<input_2=%rdx),>d1=%ymm1
vmovupd   320(%rdx),%ymm1

# qhasm: stack_FVGS1 = d1
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS1=stack256#3
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS1=64(%rsp)
vmovapd %ymm1,64(%rsp)
...
# asm 1: vmovupd   352(<input_2=int64#3),>d1=reg256#2
# asm 2: vmovupd   352(<input_2=%rdx),>d1=%ymm1
vmovupd   352(%rdx),%ymm1

# qhasm: stack_FVGS2 = d1
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS2=stack256#4
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS2=96(%rsp)
vmovapd %ymm1,96(%rsp)
...
# asm 1: vmovupd   384(<input_2=int64#3),>d1=reg256#2
# asm 2: vmovupd   384(<input_2=%rdx),>d1=%ymm1
vmovupd   384(%rdx),%ymm1

# qhasm: stack_FVGS3 = d1
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS3=stack256#5
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS3=128(%rsp)
...
# asm 1: vmovupd   416(<input_2=int64#3),>d1=reg256#2
# asm 2: vmovupd   416(<input_2=%rdx),>d1=%ymm1
vmovupd   416(%rdx),%ymm1

# qhasm: stack_FVGS4 = d1
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS4=stack256#6
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS4=160(%rsp)
...
# asm 1: vmovupd   448(<input_2=int64#3),>d1=reg256#2
# asm 2: vmovupd   448(<input_2=%rdx),>d1=%ymm1
vmovupd   448(%rdx),%ymm1

# qhasm: stack_FVGS5 = d1
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS5=stack256#7
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS5=192(%rsp)
...
# asm 1: vmovupd   480(<input_2=int64#3),>d1=reg256#2
# asm 2: vmovupd   480(<input_2=%rdx),>d1=%ymm1
vmovupd   480(%rdx),%ymm1

# qhasm: stack_FVGS6 = d1
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS6=stack256#8
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS6=224(%rsp)
...
# asm 1: vmovupd   512(<input_2=int64#3),>d1=reg256#2
# asm 2: vmovupd   512(<input_2=%rdx),>d1=%ymm1
vmovupd   512(%rdx),%ymm1

# qhasm: stack_FVGS7 = d1
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS7=stack256#9
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS7=256(%rsp)
...
# asm 1: vmovupd   544(<input_2=int64#3),>d1=reg256#2
# asm 2: vmovupd   544(<input_2=%rdx),>d1=%ymm1
vmovupd   544(%rdx),%ymm1

# qhasm: stack_FVGS8 = d1
# asm 1: vmovapd <d1=reg256#2,>stack_FVGS8=stack256#10
# asm 2: vmovapd <d1=%ymm1,>stack_FVGS8=288(%rsp)
...
# qhasm:                  f0 = z
# asm 1: mov  <z=int64#4,>f0=int64#5
# asm 2: mov  <z=%rcx,>f0=%r8
mov  %rcx,%r8
...
# asm 1: movq <_m2p15=int64#4,>stack_m2p15=stack64#9
# asm 2: movq <_m2p15=%rcx,>stack_m2p15=768(%rsp)
movq %rcx,768(%rsp)

# qhasm:             _2p16 = 65536
# asm 1: mov  $65536,>_2p16=int64#7
# asm 2: mov  $65536,>_2p16=%rax
mov  $65536,%rax

# qhasm:        stack_2p16 = _2p16
# asm 1: movq <_2p16=int64#7,>stack_2p16=stack64#10
# asm 2: movq <_2p16=%rax,>stack_2p16=776(%rsp)
movq %rax,776(%rsp)

# qhasm:             _2p31 = 2147483648
# asm 1: mov  $2147483648,>_2p31=int64#7
# asm 2: mov  $2147483648,>_2p31=%rax
mov  $2147483648,%rax

# qhasm:        stack_2p31 = _2p31     
# asm 1: movq <_2p31=int64#7,>stack_2p31=stack64#11
# asm 2: movq <_2p31=%rax,>stack_2p31=784(%rsp)
movq %rax,784(%rsp)

# qhasm:            _m2p32 = -4294967296
# asm 1: mov  $-4294967296,>_m2p32=int64#7
# asm 2: mov  $-4294967296,>_m2p32=%rax
mov  $-4294967296,%rax

# qhasm:       stack_m2p32 = _m2p32
# asm 1: movq <_m2p32=int64#7,>stack_m2p32=stack64#12
# asm 2: movq <_m2p32=%rax,>stack_m2p32=792(%rsp)
movq %rax,792(%rsp)

# qhasm:            _m2p48 = -281474976710656
# asm 1: mov  $-281474976710656,>_m2p48=int64#7
# asm 2: mov  $-281474976710656,>_m2p48=%rax
mov  $-281474976710656,%rax

# qhasm:       stack_m2p48 = _m2p48
# asm 1: movq <_m2p48=int64#7,>stack_m2p48=stack64#13
# asm 2: movq <_m2p48=%rax,>stack_m2p48=800(%rsp)
movq %rax,800(%rsp)

# qhasm:        _2p16a2p32 = 4295032832
# asm 1: mov  $4295032832,>_2p16a2p32=int64#7
# asm 2: mov  $4295032832,>_2p16a2p32=%rax
mov  $4295032832,%rax

# qhasm:   stack_2p16a2p32 = _2p16a2p32
# asm 1: movq <_2p16a2p32=int64#7,>stack_2p16a2p32=stack64#14
# asm 2: movq <_2p16a2p32=%rax,>stack_2p16a2p32=808(%rsp)
movq %rax,808(%rsp)

# qhasm: _19x4 = mem256[ input_2 +   0 ]
# asm 1: vmovupd   0(<input_2=int64#3),>_19x4=reg256#2
# asm 2: vmovupd   0(<input_2=%rdx),>_19x4=%ymm1
vmovupd   0(%rdx),%ymm1

# qhasm: stack_19x4 = _19x4
# asm 1: vmovapd <_19x4=reg256#2,>stack_19x4=stack256#11
# asm 2: vmovapd <_19x4=%ymm1,>stack_19x4=320(%rsp)
vmovapd %ymm1,320(%rsp)

# qhasm: _0_19x4 = mem256[ input_2 +  32 ]
# asm 1: vmovupd   32(<input_2=int64#3),>_0_19x4=reg256#2
# asm 2: vmovupd   32(<input_2=%rdx),>_0_19x4=%ymm1
vmovupd   32(%rdx),%ymm1

# qhasm: stack_0_19x4 = _0_19x4
# asm 1: vmovapd <_0_19x4=reg256#2,>stack_0_19x4=stack256#12
# asm 2: vmovapd <_0_19x4=%ymm1,>stack_0_19x4=352(%rsp)
vmovapd %ymm1,352(%rsp)

# qhasm: _32767x4 = mem256[ input_2 +  64 ]
# asm 1: vmovupd   64(<input_2=int64#3),>_32767x4=reg256#2
# asm 2: vmovupd   64(<input_2=%rdx),>_32767x4=%ymm1
vmovupd   64(%rdx),%ymm1

# qhasm: stack_32767x4 = _32767x4
# asm 1: vmovapd <_32767x4=reg256#2,>stack_32767x4=stack256#13
# asm 2: vmovapd <_32767x4=%ymm1,>stack_32767x4=384(%rsp)
vmovapd %ymm1,384(%rsp)

# qhasm: _inv19_2p30x4 = mem256[ input_2 +  96 ]
# asm 1: vmovupd   96(<input_2=int64#3),>_inv19_2p30x4=reg256#2
# asm 2: vmovupd   96(<input_2=%rdx),>_inv19_2p30x4=%ymm1
vmovupd   96(%rdx),%ymm1

# qhasm: stack_inv19_2p30x4 = _inv19_2p30x4
# asm 1: vmovapd <_inv19_2p30x4=reg256#2,>stack_inv19_2p30x4=stack256#14
# asm 2: vmovapd <_inv19_2p30x4=%ymm1,>stack_inv19_2p30x4=416(%rsp)
vmovapd %ymm1,416(%rsp)

# qhasm: _2p30m1x4 = mem256[ input_2 + 128 ]
# asm 1: vmovupd   128(<input_2=int64#3),>_2p30m1x4=reg256#2
# asm 2: vmovupd   128(<input_2=%rdx),>_2p30m1x4=%ymm1
vmovupd   128(%rdx),%ymm1

# qhasm: stack_2p30m1x4 = _2p30m1x4
# asm 1: vmovapd <_2p30m1x4=reg256#2,>stack_2p30m1x4=stack256#15
# asm 2: vmovapd <_2p30m1x4=%ymm1,>stack_2p30m1x4=448(%rsp)
vmovapd %ymm1,448(%rsp)

# qhasm: _2p33x4 = mem256[ input_2 + 160 ]
# asm 1: vmovupd   160(<input_2=int64#3),>_2p33x4=reg256#2
# asm 2: vmovupd   160(<input_2=%rdx),>_2p33x4=%ymm1
vmovupd   160(%rdx),%ymm1

# qhasm: stack_2p33x4 = _2p33x4
# asm 1: vmovapd <_2p33x4=reg256#2,>stack_2p33x4=stack256#16
# asm 2: vmovapd <_2p33x4=%ymm1,>stack_2p33x4=480(%rsp)
vmovapd %ymm1,480(%rsp)

# qhasm: _2p48x4 = mem256[ input_2 + 192 ]
# asm 1: vmovupd   192(<input_2=int64#3),>_2p48x4=reg256#2
# asm 2: vmovupd   192(<input_2=%rdx),>_2p48x4=%ymm1
vmovupd   192(%rdx),%ymm1

# qhasm: stack_2p48x4 = _2p48x4
# asm 1: vmovapd <_2p48x4=reg256#2,>stack_2p48x4=stack256#17
# asm 2: vmovapd <_2p48x4=%ymm1,>stack_2p48x4=512(%rsp)
vmovapd %ymm1,512(%rsp)

# qhasm: _2p63x4 = mem256[ input_2 + 224 ]
# asm 1: vmovupd   224(<input_2=int64#3),>_2p63x4=reg256#2
# asm 2: vmovupd   224(<input_2=%rdx),>_2p63x4=%ymm1
vmovupd   224(%rdx),%ymm1

# qhasm: stack_2p63x4 = _2p63x4
# asm 1: vmovapd <_2p63x4=reg256#2,>stack_2p63x4=stack256#18
# asm 2: vmovapd <_2p63x4=%ymm1,>stack_2p63x4=544(%rsp)
vmovapd %ymm1,544(%rsp)

# qhasm: _2p63m2p33x4 = mem256[ input_2 + 256 ]
# asm 1: vmovupd   256(<input_2=int64#3),>_2p63m2p33x4=reg256#2
# asm 2: vmovupd   256(<input_2=%rdx),>_2p63m2p33x4=%ymm1
vmovupd   256(%rdx),%ymm1

# qhasm: i = 12
# asm 1: mov  $12,>i=int64#9
# asm 2: mov  $12,>i=%r11
mov  $12,%r11

# qhasm: u = 1152921504606846976
# asm 1: mov  $1152921504606846976,>u=int64#10
# asm 2: mov  $1152921504606846976,>u=%r12
mov  $1152921504606846976,%r12

# qhasm: v = 0
# asm 1: xor  >v=int64#11,>v=int64#11
# asm 2: xor  >v=%r13,>v=%r13
xor  %r13,%r13

# qhasm: s = u
# asm 1: mov  <u=int64#10,>s=int64#12
# asm 2: mov  <u=%r12,>s=%r14
mov  %r12,%r14

# qhasm: r = 0
# asm 1: xor  >r=int64#13,>r=int64#13
# asm 2: xor  >r=%r15,>r=%r15
xor  %r15,%r15
...
# asm 1: vpinsrq $0x0,<u=int64#10,<uuss=reg256#1%128,<uuss=reg256#1%128
# asm 2: vpinsrq $0x0,<u=%r12,<uuss=%xmm0,<uuss=%xmm0
vpinsrq $0x0,%r12,%xmm0,%xmm0

# qhasm: vvrr = v,vvrr[1],0,0
# asm 1: vpinsrq $0x0,<v=int64#11,<vvrr=reg256#3%128,<vvrr=reg256#3%128
# asm 2: vpinsrq $0x0,<v=%r13,<vvrr=%xmm2,<vvrr=%xmm2
vpinsrq $0x0,%r13,%xmm2,%xmm2

# qhasm: uuss = uuss[0],s,0,0
# asm 1: vpinsrq $0x1,<s=int64#12,<uuss=reg256#1%128,<uuss=reg256#1%128
# asm 2: vpinsrq $0x1,<s=%r14,<uuss=%xmm0,<uuss=%xmm0
vpinsrq $0x1,%r14,%xmm0,%xmm0

# qhasm: vvrr = vvrr[0],r,0,0
# asm 1: vpinsrq $0x1,<r=int64#13,<vvrr=reg256#3%128,<vvrr=reg256#3%128
# asm 2: vpinsrq $0x1,<r=%r15,<vvrr=%xmm2,<vvrr=%xmm2
vpinsrq $0x1,%r15,%xmm2,%xmm2

# qhasm:       rax = g
# asm 1: mov  <g=int64#8,>rax=int64#7
# asm 2: mov  <g=%r10,>rax=%rax
mov  %r10,%rax

# qhasm:       (int128) rdx rax = rax * s
# asm 1: imul <s=int64#12
# asm 2: imul <s=%r14
imul %r14
...
# qhasm:       v *= g0
# asm 1: imul  <g0=int64#6,<v=int64#11
# asm 2: imul  <g0=%r9,<v=%r13
imul  %r9,%r13

# qhasm:       g0 *= s  
# asm 1: imul  <s=int64#12,<g0=int64#6
# asm 2: imul  <s=%r14,<g0=%r9
imul  %r14,%r9

# qhasm:       r *= f0
# asm 1: imul  <f0=int64#5,<r=int64#13
# asm 2: imul  <f0=%r8,<r=%r15
imul  %r8,%r15

# qhasm:       f0 *= u
# asm 1: imul  <u=int64#10,<f0=int64#5
# asm 2: imul  <u=%r12,<f0=%r8
imul  %r12,%r8

# qhasm:       f0 += v
# asm 1: add  <v=int64#11,<f0=int64#5
# asm 2: add  <v=%r13,<f0=%r8
add  %r13,%r8

# qhasm:       g0 += r
# asm 1: add  <r=int64#13,<g0=int64#6
# asm 2: add  <r=%r15,<g0=%r9
add  %r15,%r9
...
# qhasm: g=t2+g0       
# asm 1: lea  (<t2=int64#14,<g0=int64#6),>g=int64#3
# asm 2: lea  (<t2=%rbx,<g0=%r9),>g=%rdx
lea  (%rbx,%r9),%rdx

# qhasm: FVGS0 = stack_FVGS0
# asm 1: vmovapd <stack_FVGS0=stack256#2,>FVGS0=reg256#4
# asm 2: vmovapd <stack_FVGS0=32(%rsp),>FVGS0=%ymm3
vmovapd 32(%rsp),%ymm3
...
# qhasm:   fuv = f & ~ _m2p15
# asm 1: andn  <f=int64#1,<_m2p15=int64#4,>fuv=int64#5
# asm 2: andn  <f=%rdi,<_m2p15=%rcx,>fuv=%r8
andn  %rdi,%rcx,%r8

# qhasm:   grs = g & ~ _m2p15
# asm 1: andn  <g=int64#3,<_m2p15=int64#4,>grs=int64#6
# asm 2: andn  <g=%rdx,<_m2p15=%rcx,>grs=%r9
andn  %rdx,%rcx,%r9

# qhasm:   fuv |= stack_m2p32
# asm 1: orq  <stack_m2p32=stack64#12,<fuv=int64#5
# asm 2: orq  <stack_m2p32=792(%rsp),<fuv=%r8
orq  792(%rsp),%r8

# qhasm:   grs |= stack_m2p48
# asm 1: orq  <stack_m2p48=stack64#13,<grs=int64#6
# asm 2: orq  <stack_m2p48=800(%rsp),<grs=%r9
orq  800(%rsp),%r9
...
# qhasm:   mnew = stack_m1[0]
# asm 1: movq <stack_m1=stack256#1,>mnew=int64#10
# asm 2: movq <stack_m1=0(%rsp),>mnew=%r12
movq 0(%rsp),%r12
...
# asm 1: vpermq $0x4e,<FVGS0=reg256#4,>GSFV0=reg256#5
# asm 2: vpermq $0x4e,<FVGS0=%ymm3,>GSFV0=%ymm4
...
# asm 1: vpermq $0x50,<uuss=reg256#1,>uuss=reg256#1
# asm 2: vpermq $0x50,<uuss=%ymm0,>uuss=%ymm0
vpermq $0x50,%ymm0,%ymm0

# qhasm: vvrr = vvrr[0,0,1,1]
# asm 1: vpermq $0x50,<vvrr=reg256#3,>vvrr=reg256#3
# asm 2: vpermq $0x50,<vvrr=%ymm2,>vvrr=%ymm2
...
# asm 1: vpand <uuss=reg256#1,<_2p30m1x4=reg256#6,>uuss0=reg256#7
# asm 2: vpand <uuss=%ymm0,<_2p30m1x4=%ymm5,>uuss0=%ymm6
...
# asm 1: cmovl <oldg=int64#11,<fuv=int64#5
# asm 2: cmovl <oldg=%r13,<fuv=%r8
cmovl %r13,%r8
...
# asm 1: vpand <vvrr=reg256#3,<_2p30m1x4=reg256#6,>vvrr0=reg256#8
# asm 2: vpand <vvrr=%ymm2,<_2p30m1x4=%ymm5,>vvrr0=%ymm7
vpand %ymm2,%ymm5,%ymm7
...
# asm 1: vpmuldq <uuss0=reg256#7,<FVGS0=reg256#4,>ta=reg256#9
# asm 2: vpmuldq <uuss0=%ymm6,<FVGS0=%ymm3,>ta=%ymm8
vpmuldq %ymm6,%ymm3,%ymm8
...
# asm 1: vpsrlq $30,<uuss=reg256#1,>uuss1=reg256#1
# asm 2: vpsrlq $30,<uuss=%ymm0,>uuss1=%ymm0
vpsrlq $30,%ymm0,%ymm0
...
# asm 1: vpsrlq $30,<vvrr=reg256#3,>vvrr1=reg256#3
# asm 2: vpsrlq $30,<vvrr=%ymm2,>vvrr1=%ymm2
vpsrlq $30,%ymm2,%ymm2

# qhasm: 4x ta = int32 uuss1 * int32 FVGS0
# asm 1: vpmuldq <uuss1=reg256#1,<FVGS0=reg256#4,>ta=reg256#4
# asm 2: vpmuldq <uuss1=%ymm0,<FVGS0=%ymm3,>ta=%ymm3
...
# asm 1: vpmuldq <vvrr1=reg256#3,<GSFV0=reg256#5,>tb=reg256#5
# asm 2: vpmuldq <vvrr1=%ymm2,<GSFV0=%ymm4,>tb=%ymm4
...
# qhasm: 4x out1 = ta + tb
# asm 1: vpaddq <ta=reg256#4,<tb=reg256#5,>out1=reg256#4
# asm 2: vpaddq <ta=%ymm3,<tb=%ymm4,>out1=%ymm3
...
# asm 1: vpaddq <out1=reg256#4,<out1plus=reg256#15,<out1=reg256#4
# asm 2: vpaddq <out1=%ymm3,<out1plus=%ymm14,<out1=%ymm3
...
# asm 1: vpaddq <out1=reg256#4,<carryy=reg256#9,<out1=reg256#4
# asm 2: vpaddq <out1=%ymm3,<carryy=%ymm8,<out1=%ymm3
...
# asm 1: vpmuldq <out1=reg256#4,<_inv19_2p30x4=reg256#10,>d1=reg256#5
# asm 2: vpmuldq <out1=%ymm3,<_inv19_2p30x4=%ymm9,>d1=%ymm4
vpmuldq %ymm3,%ymm9,%ymm4
...
# qhasm: 4x out1 -= d1x19
# asm 1: vpsubq <d1x19=reg256#9,<out1=reg256#4,<out1=reg256#4
# asm 2: vpsubq <d1x19=%ymm8,<out1=%ymm3,<out1=%ymm3
...
# asm 1: vpaddq <out1=reg256#4,<_2p63m2p33x4=reg256#2,>carryy=reg256#4
# asm 2: vpaddq <out1=%ymm3,<_2p63m2p33x4=%ymm1,>carryy=%ymm3
...
# asm 1: vpmuldq <uuss1=reg256#1,<FVGS1=reg256#13,>ta=reg256#11
# asm 2: vpmuldq <uuss1=%ymm0,<FVGS1=%ymm12,>ta=%ymm10
vpmuldq %ymm0,%ymm12,%ymm10
...
# asm 1: vpmuldq <vvrr1=reg256#3,<GSFV1=reg256#14,>tb=reg256#13
# asm 2: vpmuldq <vvrr1=%ymm2,<GSFV1=%ymm13,>tb=%ymm12
vpmuldq %ymm2,%ymm13,%ymm12
...
# asm 1: vpaddq <out2=reg256#13,<carryy=reg256#4,<out2=reg256#13
# asm 2: vpaddq <out2=%ymm12,<carryy=%ymm3,<out2=%ymm12
...
# asm 1: vpaddq <out2=reg256#13,<_2p63m2p33x4=reg256#2,>carryy=reg256#4
# asm 2: vpaddq <out2=%ymm12,<_2p63m2p33x4=%ymm1,>carryy=%ymm3
vpaddq %ymm12,%ymm1,%ymm3
...
# asm 1: vpmuldq <uuss1=reg256#1,<FVGS2=reg256#9,>ta=reg256#9
# asm 2: vpmuldq <uuss1=%ymm0,<FVGS2=%ymm8,>ta=%ymm8
...
# asm 1: vpmuldq <vvrr1=reg256#3,<GSFV2=reg256#10,>tb=reg256#10
# asm 2: vpmuldq <vvrr1=%ymm2,<GSFV2=%ymm9,>tb=%ymm9
...
# asm 1: vpaddq <out3=reg256#10,<carryy=reg256#4,<out3=reg256#10
# asm 2: vpaddq <out3=%ymm9,<carryy=%ymm3,<out3=%ymm9
...
# asm 1: vpaddq <out3=reg256#10,<_2p63m2p33x4=reg256#2,>carryy=reg256#4
# asm 2: vpaddq <out3=%ymm9,<_2p63m2p33x4=%ymm1,>carryy=%ymm3
vpaddq %ymm9,%ymm1,%ymm3
...
# asm 1: vpmuldq <uuss1=reg256#1,<FVGS3=reg256#11,>ta=reg256#11
# asm 2: vpmuldq <uuss1=%ymm0,<FVGS3=%ymm10,>ta=%ymm10
...
# asm 1: vpmuldq <vvrr1=reg256#3,<GSFV3=reg256#14,>tb=reg256#14
# asm 2: vpmuldq <vvrr1=%ymm2,<GSFV3=%ymm13,>tb=%ymm13
vpmuldq %ymm2,%ymm13,%ymm13
...
# asm 1: vpaddq <out4=reg256#14,<carryy=reg256#4,<out4=reg256#14
# asm 2: vpaddq <out4=%ymm13,<carryy=%ymm3,<out4=%ymm13
...
# asm 1: vpaddq <out4=reg256#14,<_2p63m2p33x4=reg256#2,>carryy=reg256#4
# asm 2: vpaddq <out4=%ymm13,<_2p63m2p33x4=%ymm1,>carryy=%ymm3
...
# asm 1: vpmuldq <uuss1=reg256#1,<FVGS4=reg256#9,>ta=reg256#9
# asm 2: vpmuldq <uuss1=%ymm0,<FVGS4=%ymm8,>ta=%ymm8
vpmuldq %ymm0,%ymm8,%ymm8
...
# asm 1: vpmuldq <vvrr1=reg256#3,<GSFV4=reg256#10,>tb=reg256#10
# asm 2: vpmuldq <vvrr1=%ymm2,<GSFV4=%ymm9,>tb=%ymm9
vpmuldq %ymm2,%ymm9,%ymm9
...
# asm 1: vpaddq <out5=reg256#10,<carryy=reg256#4,<out5=reg256#10
# asm 2: vpaddq <out5=%ymm9,<carryy=%ymm3,<out5=%ymm9
vpaddq %ymm9,%ymm3,%ymm9
...
# asm 1: vpaddq <out5=reg256#10,<_2p63m2p33x4=reg256#2,>carryy=reg256#4
# asm 2: vpaddq <out5=%ymm9,<_2p63m2p33x4=%ymm1,>carryy=%ymm3
vpaddq %ymm9,%ymm1,%ymm3
...
# asm 1: vpmuldq <uuss1=reg256#1,<FVGS5=reg256#11,>ta=reg256#11
# asm 2: vpmuldq <uuss1=%ymm0,<FVGS5=%ymm10,>ta=%ymm10
vpmuldq %ymm0,%ymm10,%ymm10

# qhasm: 4x tb = int32 vvrr1 * int32 GSFV5
# asm 1: vpmuldq <vvrr1=reg256#3,<GSFV5=reg256#15,>tb=reg256#15
# asm 2: vpmuldq <vvrr1=%ymm2,<GSFV5=%ymm14,>tb=%ymm14
vpmuldq %ymm2,%ymm14,%ymm14
...
# asm 1: vpaddq <out6=reg256#15,<carryy=reg256#4,<out6=reg256#15
# asm 2: vpaddq <out6=%ymm14,<carryy=%ymm3,<out6=%ymm14
...
# asm 1: vpaddq <out6=reg256#15,<_2p63m2p33x4=reg256#2,>carryz=reg256#4
# asm 2: vpaddq <out6=%ymm14,<_2p63m2p33x4=%ymm1,>carryz=%ymm3
vpaddq %ymm14,%ymm1,%ymm3

# qhasm: 4x carryz unsigned>>= 30
# asm 1: vpsrlq $30,<carryz=reg256#4,<carryz=reg256#4
# asm 2: vpsrlq $30,<carryz=%ymm3,<carryz=%ymm3
vpsrlq $30,%ymm3,%ymm3
...
# asm 1: vpmuldq <uuss1=reg256#1,<FVGS6=reg256#9,>ta=reg256#9
# asm 2: vpmuldq <uuss1=%ymm0,<FVGS6=%ymm8,>ta=%ymm8
vpmuldq %ymm0,%ymm8,%ymm8
...
# asm 1: vpmuldq <vvrr1=reg256#3,<GSFV6=reg256#14,>tb=reg256#14
# asm 2: vpmuldq <vvrr1=%ymm2,<GSFV6=%ymm13,>tb=%ymm13
vpmuldq %ymm2,%ymm13,%ymm13
...
# asm 1: vpaddq <out7=reg256#14,<carryz=reg256#4,<out7=reg256#14
# asm 2: vpaddq <out7=%ymm13,<carryz=%ymm3,<out7=%ymm13
vpaddq %ymm13,%ymm3,%ymm13
...
# asm 1: vpaddq <out7=reg256#14,<_2p63m2p33x4=reg256#2,>carryz=reg256#4
# asm 2: vpaddq <out7=%ymm13,<_2p63m2p33x4=%ymm1,>carryz=%ymm3
vpaddq %ymm13,%ymm1,%ymm3
...
# asm 1: vpmuldq <uuss1=reg256#1,<FVGS7=reg256#10,>ta=reg256#10
# asm 2: vpmuldq <uuss1=%ymm0,<FVGS7=%ymm9,>ta=%ymm9
...
# asm 1: vpmuldq <vvrr1=reg256#3,<GSFV7=reg256#11,>tb=reg256#11
# asm 2: vpmuldq <vvrr1=%ymm2,<GSFV7=%ymm10,>tb=%ymm10
...
# asm 1: vpaddq <out8=reg256#7,<carryz=reg256#4,<out8=reg256#7
# asm 2: vpaddq <out8=%ymm6,<carryz=%ymm3,<out8=%ymm6
...
# asm 1: vpaddq <out8=reg256#7,<_2p63m2p33x4=reg256#2,>carryz=reg256#4
# asm 2: vpaddq <out8=%ymm6,<_2p63m2p33x4=%ymm1,>carryz=%ymm3
vpaddq %ymm6,%ymm1,%ymm3
...
# asm 1: vpmuldq <uuss1=reg256#1,<FVGS8=reg256#9,>ta=reg256#1
# asm 2: vpmuldq <uuss1=%ymm0,<FVGS8=%ymm8,>ta=%ymm0
vpmuldq %ymm0,%ymm8,%ymm0

# qhasm: 4x tb = int32 vvrr1 * int32 GSFV8
# asm 1: vpmuldq <vvrr1=reg256#3,<GSFV8=reg256#15,>tb=reg256#3
# asm 2: vpmuldq <vvrr1=%ymm2,<GSFV8=%ymm14,>tb=%ymm2
vpmuldq %ymm2,%ymm14,%ymm2
...
# asm 1: vpaddq <ta=reg256#1,<tb=reg256#3,>out9plus=reg256#1
# asm 2: vpaddq <ta=%ymm0,<tb=%ymm2,>out9plus=%ymm0
...
# asm 1: vpaddq <out9=reg256#5,<out9plus=reg256#1,<out9=reg256#5
# asm 2: vpaddq <out9=%ymm4,<out9plus=%ymm0,<out9=%ymm4
vpaddq %ymm4,%ymm0,%ymm4

# qhasm: 4x out9 += carryz
# asm 1: vpaddq <out9=reg256#5,<carryz=reg256#4,<out9=reg256#5
# asm 2: vpaddq <out9=%ymm4,<carryz=%ymm3,<out9=%ymm4
...
# asm 2: movq <stack_2p16a2p32=808(%rsp),>_2p16a2p32=%rax
movq 808(%rsp),%rax

# qhasm: 4x out10 = out9 + _2p63m2p33x4 
# asm 1: vpaddq <out9=reg256#5,<_2p63m2p33x4=reg256#2,>out10=reg256#1
# asm 2: vpaddq <out9=%ymm4,<_2p63m2p33x4=%ymm1,>out10=%ymm0
...
# asm 1: vpaddq <out10=reg256#1,<_2p63m2p33x4=reg256#2,>carryy=reg256#7
# asm 2: vpaddq <out10=%ymm0,<_2p63m2p33x4=%ymm1,>carryy=%ymm6
vpaddq %ymm0,%ymm1,%ymm6

# qhasm:   _2p16 = stack_2p16
# asm 1: movq <stack_2p16=stack64#10,>_2p16=int64#11
# asm 2: movq <stack_2p16=776(%rsp),>_2p16=%r13
movq 776(%rsp),%r13

# qhasm:   grs += _2p16
# asm 1: add  <_2p16=int64#11,<grs=int64#6
# asm 2: add  <_2p16=%r13,<grs=%r9
add  %r13,%r9
...
# asm 1: vpsubq <stack_2p33x4=stack256#16,<out10=reg256#1,<out10=reg256#1
# asm 2: vpsubq <stack_2p33x4=480(%rsp),<out10=%ymm0,<out10=%ymm0
vpsubq 480(%rsp),%ymm0,%ymm0

# qhasm:   fuv += _2p16
# asm 1: add  <_2p16=int64#11,<fuv=int64#5
# asm 2: add  <_2p16=%r13,<fuv=%r8
add  %r13,%r8
...
# asm 1: vpand <out10=reg256#1,<_32767x4=reg256#3,<out10=reg256#1
# asm 2: vpand <out10=%ymm0,<_32767x4=%ymm2,<out10=%ymm0
...
# asm 2: orq  <stack_m2p32=792(%rsp),<fuv=%r9
orq  792(%rsp),%r9

# qhasm:   grs |= stack_m2p48
# asm 1: orq  <stack_m2p48=stack64#13,<grs=int64#7
# asm 2: orq  <stack_m2p48=800(%rsp),<grs=%rax
orq  800(%rsp),%rax
...
# qhasm:   grs = h    if !signed<
# asm 1: cmovge <h=int64#10,<grs=int64#7
# asm 2: cmovge <h=%r12,<grs=%rax
cmovge %r12,%rax
...
# qhasm:   mnew = stack_m1[0]
# asm 1: movq <stack_m1=stack256#1,>mnew=int64#11
# asm 2: movq <stack_m1=0(%rsp),>mnew=%r13
movq 0(%rsp),%r13
...
# asm 2: movq <stack_2p16a2p32=808(%rsp),>_2p16a2p32=%r10
movq 808(%rsp),%r10

# qhasm:   s = grs + _2p16a2p32
# asm 1: lea  (<grs=int64#7,<_2p16a2p32=int64#8),>s=int64#10
# asm 2: lea  (<grs=%rax,<_2p16a2p32=%r10),>s=%r12
lea  (%rax,%r10),%r12
...
# qhasm:   t2 *= v
# asm 1: imul  <v=int64#8,<t2=int64#11
# asm 2: imul  <v=%r10,<t2=%r13
imul  %r10,%r13

# qhasm:   _2p16 = stack_2p16
# asm 1: movq <stack_2p16=stack64#10,>_2p16=int64#12
# asm 2: movq <stack_2p16=776(%rsp),>_2p16=%r14
movq 776(%rsp),%r14
...
# qhasm:   t0 *= u
# asm 1: imul  <u=int64#6,<t0=int64#11
# asm 2: imul  <u=%r9,<t0=%r13
imul  %r9,%r13
...
# qhasm:   u = t0 + t1
# asm 1: lea  (<t0=int64#11,<t1=int64#12),>u=int64#6
# asm 2: lea  (<t0=%r13,<t1=%r14),>u=%r9
lea  (%r13,%r14),%r9

# qhasm:   r += s
# asm 1: add  <s=int64#10,<r=int64#7
# asm 2: add  <s=%r12,<r=%rax
add  %r12,%rax
...
# qhasm:   _2p16a2p32 = stack_2p16a2p32
# asm 1: movq <stack_2p16a2p32=stack64#14,>_2p16a2p32=int64#1
# asm 2: movq <stack_2p16a2p32=808(%rsp),>_2p16a2p32=%rdi
movq 808(%rsp),%rdi

# qhasm:   s = grs + _2p16a2p32
# asm 1: lea  (<grs=int64#7,<_2p16a2p32=int64#1),>s=int64#3
# asm 2: lea  (<grs=%rax,<_2p16a2p32=%rdi),>s=%rdx
lea  (%rax,%rdi),%rdx
...
# qhasm:   v = fuv + _2p16a2p32
# asm 1: lea  (<fuv=int64#6,<_2p16a2p32=int64#1),>v=int64#11
# asm 2: lea  (<fuv=%r9,<_2p16a2p32=%rdi),>v=%r13
lea  (%r9,%rdi),%r13

# qhasm:   (int64) v >>= 33
# asm 1: sar  $33,<v=int64#11
# asm 2: sar  $33,<v=%r13
sar  $33,%r13
...
# qhasm:   t1 *= v
# asm 1: imul  <v=int64#11,<t1=int64#1
# asm 2: imul  <v=%r13,<t1=%rdi
imul  %r13,%rdi

# qhasm:   stimesolds = stack_uuss[2]
# asm 1: movq <stack_uuss=stack256#19,>stimesolds=int64#5
# asm 2: movq <stack_uuss=592(%rsp),>stimesolds=%r8
movq 592(%rsp),%r8

# qhasm:   v *= stimesolds
# asm 1: imul  <stimesolds=int64#5,<v=int64#11
# asm 2: imul  <stimesolds=%r8,<v=%r13
imul  %r8,%r13

# qhasm:   stimesolds *= s
# asm 1: imul  <s=int64#3,<stimesolds=int64#5
# asm 2: imul  <s=%rdx,<stimesolds=%r8
imul  %rdx,%r8

# qhasm:   _2p16 = stack_2p16
# asm 1: movq <stack_2p16=stack64#10,>_2p16=int64#8
# asm 2: movq <stack_2p16=776(%rsp),>_2p16=%r10
movq 776(%rsp),%r10

# qhasm:   grs += _2p16
# asm 1: add  <_2p16=int64#8,<grs=int64#7
# asm 2: add  <_2p16=%r10,<grs=%rax
add  %r10,%rax
...
# qhasm:   r = (int16) grs
# asm 1: movsx <grs=int64#7w,>r=int64#13
# asm 2: movsx <grs=%ax,>r=%r15
movsx %ax,%r15

# qhasm:   fuv += _2p16
# asm 1: add  <_2p16=int64#8,<fuv=int64#6
# asm 2: add  <_2p16=%r10,<fuv=%r9
add  %r10,%r9
...
# qhasm:   t0 = stack_uuss[0]
# asm 1: movq <stack_uuss=stack256#19,>t0=int64#7
# asm 2: movq <stack_uuss=576(%rsp),>t0=%rax
movq 576(%rsp),%rax

# qhasm:   t0 *= u
# asm 1: imul  <u=int64#6,<t0=int64#7
# asm 2: imul  <u=%r9,<t0=%rax
imul  %r9,%rax

# qhasm:   rtimesoldv = stack_vvrr[0]
# asm 1: movq <stack_vvrr=stack256#20,>rtimesoldv=int64#8
# asm 2: movq <stack_vvrr=608(%rsp),>rtimesoldv=%r10
movq 608(%rsp),%r10

# qhasm:   u *= rtimesoldv
# asm 1: imul  <rtimesoldv=int64#8,<u=int64#6
# asm 2: imul  <rtimesoldv=%r10,<u=%r9
imul  %r10,%r9

# qhasm:   rtimesoldv *= r
# asm 1: imul  <r=int64#13,<rtimesoldv=int64#8
# asm 2: imul  <r=%r15,<rtimesoldv=%r10
imul  %r15,%r10
...
# qhasm:   r *= stack_uuss[0]
# asm 1: imulq <stack_uuss=stack256#19,<r=int64#13
# asm 2: imulq <stack_uuss=576(%rsp),<r=%r15
imulq 576(%rsp),%r15

# qhasm:   v += u
# asm 1: add  <u=int64#6,<v=int64#11
# asm 2: add  <u=%r9,<v=%r13
add  %r9,%r13

# qhasm:   u = t0 + t1
# asm 1: lea  (<t0=int64#7,<t1=int64#1),>u=int64#10
# asm 2: lea  (<t0=%rax,<t1=%rdi),>u=%r12
lea  (%rax,%rdi),%r12

# qhasm:   r += s
# asm 1: add  <s=int64#3,<r=int64#13
# asm 2: add  <s=%rdx,<r=%r15
add  %rdx,%r15

# qhasm:   s = rtimesoldv + stimesolds
# asm 1: lea  (<rtimesoldv=int64#8,<stimesolds=int64#5),>s=int64#12
# asm 2: lea  (<rtimesoldv=%r10,<stimesolds=%r8),>s=%r14
lea  (%r10,%r8),%r14
...
# asm 1: movq <stack_fxgx=stack256#21,>g=int64#8
# asm 2: movq <stack_fxgx=656(%rsp),>g=%r10
movq 656(%rsp),%r10

# qhasm:   f0 = stack_fygy[0]
# asm 1: movq <stack_fygy=stack256#22,>f0=int64#5
# asm 2: movq <stack_fygy=672(%rsp),>f0=%r8
movq 672(%rsp),%r8

# qhasm:   g0 = stack_fygy[2]
# asm 1: movq <stack_fygy=stack256#22,>g0=int64#6
# asm 2: movq <stack_fygy=688(%rsp),>g0=%r9
movq 688(%rsp),%r9
...
# qhasm: f0 <<= 60
# asm 1: shl  $60,<f0=int64#5
# asm 2: shl  $60,<f0=%r8
shl  $60,%r8

# qhasm: g0 <<= 60
# asm 1: shl  $60,<g0=int64#6
# asm 2: shl  $60,<g0=%r9
shl  $60,%r9
...
# qhasm: g += g0
# asm 1: add  <g0=int64#6,<g=int64#8
# asm 2: add  <g0=%r9,<g=%r10
add  %r9,%r10

# qhasm: f *= u
# asm 1: imul  <u=int64#10,<f=int64#1
# asm 2: imul  <u=%r12,<f=%rdi
imul  %r12,%rdi

# qhasm: g *= v
# asm 1: imul  <v=int64#11,<g=int64#8
# asm 2: imul  <v=%r13,<g=%r10
imul  %r13,%r10

# qhasm: t0 = f + g
# asm 1: lea  (<f=int64#1,<g=int64#8),>t0=int64#1
# asm 2: lea  (<f=%rdi,<g=%r10),>t0=%rdi
lea  (%rdi,%r10),%rdi
...
# qhasm: u *= t0
# asm 1: imul  <t0=int64#1,<u=int64#10
# asm 2: imul  <t0=%rdi,<u=%r12
imul  %rdi,%r12

# qhasm: v *= t0
# asm 1: imul  <t0=int64#1,<v=int64#11
# asm 2: imul  <t0=%rdi,<v=%r13
imul  %rdi,%r13
...
# qhasm: a1 = t1
# asm 1: mov  <t1=int64#5,>a1=int64#8
# asm 2: mov  <t1=%r8,>a1=%r10
mov  %r8,%r10
...
# qhasm: a0 = t1
# asm 1: mov  <t1=int64#5,>a0=int64#9
# asm 2: mov  <t1=%r8,>a0=%r11
mov  %r8,%r11
...
# qhasm: carry? a1 += t1
# asm 1: add  <t1=int64#5,<a1=int64#8
# asm 2: add  <t1=%r8,<a1=%r10
add  %r8,%r10
...
# qhasm: carry? a0 += t1
# asm 1: add  <t1=int64#5,<a0=int64#9
# asm 2: add  <t1=%r8,<a0=%r11
add  %r8,%r11

# qhasm: carry? a1 += t2 + carry
# asm 1: adc <t2=int64#4,<a1=int64#8
# asm 2: adc <t2=%rcx,<a1=%r10
adc %rcx,%r10
...
# qhasm: carry?   a0 += rax
# asm 1: add  <rax=int64#7,<a0=int64#9
# asm 2: add  <rax=%rax,<a0=%r11
add  %rax,%r11

# qhasm: carry?   a1 += rdx + carry
# asm 1: adc <rdx=int64#3,<a1=int64#8
# asm 2: adc <rdx=%rdx,<a1=%r10
adc %rdx,%r10
...
# qhasm: carry? a0 += a4
# asm 1: add  <a4=int64#3,<a0=int64#9
# asm 2: add  <a4=%rdx,<a0=%r11
add  %rdx,%r11

# qhasm: carry? a1 += a5 + carry
# asm 1: adc <a5=int64#4,<a1=int64#8
# asm 2: adc <a5=%rcx,<a1=%r10
adc %rcx,%r10
...
# qhasm: carry?   a0 += 19
# asm 1: add  $19,<a0=int64#9
# asm 2: add  $19,<a0=%r11
add  $19,%r11

# qhasm: carry?   a1 += 0 + carry
# asm 1: adc $0,<a1=int64#8
# asm 2: adc $0,<a1=%r10
adc $0,%r10
...
# qhasm: carry? a0 += t0
# asm 1: add  <t0=int64#1,<a0=int64#9
# asm 2: add  <t0=%rdi,<a0=%r11
add  %rdi,%r11
...
# qhasm: carry?   a0 -= 19
# asm 1: sub  $19,<a0=int64#9
# asm 2: sub  $19,<a0=%r11
sub  $19,%r11

# qhasm: carry?   a1 -= 0 - carry
# asm 1: sbb  $0,<a1=int64#8
# asm 2: sbb  $0,<a1=%r10
sbb  $0,%r10
...
# qhasm: t2 = stack_out
# asm 1: movq <stack_out=stack64#8,>t2=int64#1
# asm 2: movq <stack_out=760(%rsp),>t2=%rdi
movq 760(%rsp),%rdi

# qhasm: mem64[t2 +  0] = a0
# asm 1: movq   <a0=int64#9,0(<t2=int64#1)
# asm 2: movq   <a0=%r11,0(<t2=%rdi)
movq   %r11,0(%rdi)

# qhasm: mem64[t2 +  8] = a1
# asm 1: movq   <a1=int64#8,8(<t2=int64#1)
# asm 2: movq   <a1=%r10,8(<t2=%rdi)
movq   %r10,8(%rdi)
