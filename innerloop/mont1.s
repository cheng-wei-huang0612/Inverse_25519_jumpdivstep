...
# asm 2: movq <input_1=%rsi,>stack_out=800(%rsp)
movq %rsi,800(%rsp)
...
# asm 2: movq <caller_r11=%r11,>stack_r11=808(%rsp)
movq %r11,808(%rsp)
...
# asm 2: movq <caller_r12=%r12,>stack_r12=816(%rsp)
movq %r12,816(%rsp)
...
# asm 2: movq <caller_r13=%r13,>stack_r13=824(%rsp)
movq %r13,824(%rsp)
...
# asm 2: movq <caller_r14=%r14,>stack_r14=832(%rsp)
movq %r14,832(%rsp)
...
# asm 2: movq <caller_r15=%r15,>stack_r15=840(%rsp)
movq %r15,840(%rsp)
...
# asm 2: movq <caller_rbx=%rbx,>stack_rbx=848(%rsp)
movq %rbx,848(%rsp)
...
# asm 2: movq <caller_rbp=%rbp,>stack_rbp=856(%rsp)
movq %rbp,856(%rsp)
...
# asm 2: movq <minv=%rdi,>stack_minv=864(%rsp)
movq %rdi,864(%rsp)
...
# asm 2: movq <_m2p20=%r8,>stack_m2p20=872(%rsp)
movq %r8,872(%rsp)
...
# asm 2: movq <_2p20=%rax,>stack_2p20=880(%rsp)
movq %rax,880(%rsp)
...
# asm 2: movq <_m2p41=%rax,>stack_m2p41=888(%rsp)
movq %rax,888(%rsp)
...
# asm 2: movq <_m2p62=%rax,>stack_m2p62=896(%rsp)
movq %rax,896(%rsp)
...
# asm 2: movq <_2p20a2p41=%rax,>stack_2p20a2p41=904(%rsp)
movq %rax,904(%rsp)
...
# asm 2: vpbroadcastq <stack_minv=864(%rsp),>minvx4=%ymm9
vpbroadcastq 864(%rsp),%ymm9
...
# asm 2: addq <stack_m2p41=888(%rsp),<fuv=%rdx
addq 888(%rsp),%rdx

# qhasm:   grs += stack_m2p62
# asm 1: addq <stack_m2p62=stack64#13,<grs=int64#6
# asm 2: addq <stack_m2p62=896(%rsp),<grs=%r9
addq 896(%rsp),%r9
...
# asm 2: movq <stack_2p20a2p41=904(%rsp),>_2p20a2p41=%rax
movq 904(%rsp),%rax
...
# asm 2: movq <stack_2p20=880(%rsp),>_2p20=%r13
movq 880(%rsp),%r13
...
# asm 2: addq <stack_m2p41=888(%rsp),<fuv=%rax
addq 888(%rsp),%rax
...
# asm 2: movq <stack_2p20a2p41=904(%rsp),>_2p20a2p41=%r11
movq 904(%rsp),%r11
...
# asm 2: movq <stack_2p20=880(%rsp),>_2p20=%r14
movq 880(%rsp),%r14
...
# asm 2: movq <stack_2p20a2p41=904(%rsp),>_2p20a2p41=%rdi
movq 904(%rsp),%rdi
...
# asm 2: movq <stack_2p20=880(%rsp),>_2p20=%r11
movq 880(%rsp),%r11
...
# asm 2: vmovapd <stack_2p30m1x4=0(%rsp),>_2p30m1x4=%ymm12
vmovapd 0(%rsp),%ymm12
...
# asm 2: vmovapd <stack_2p30m1x4=0(%rsp),>_2p30m1x4=%ymm7
vmovapd 0(%rsp),%ymm7
...
# asm 2: vmovapd <out3=%ymm3,>stack_FVGS0=32(%rsp)
vmovapd %ymm3,32(%rsp)
...
# asm 2: vmovapd <stack_2p30m1x4=0(%rsp),>_2p30m1x4=%ymm8
vmovapd 0(%rsp),%ymm8
...
# asm 2: vmovapd <out4=%ymm10,>stack_FVGS1=64(%rsp)
vmovapd %ymm10,64(%rsp)
...
# asm 2: vmovapd <out5=%ymm3,>stack_FVGS2=96(%rsp)
vmovapd %ymm3,96(%rsp)
...
# asm 2: vmovapd <out7=%ymm3,>stack_FVGS4=160(%rsp)
...
# asm 2: vmovapd <stack_2p30m1x4=0(%rsp),>_2p30m1x4=%ymm6
vmovapd 0(%rsp),%ymm6
...
# asm 2: vmovapd <out8=%ymm8,>stack_FVGS5=0(%rsp)
vmovapd %ymm8,0(%rsp)
...
# asm 2: movq <stack_out=800(%rsp),>t2=%rdi
movq 800(%rsp),%rdi

# qhasm: a0 = stack_FVGS0[1]
# asm 1: movq <stack_FVGS0=stack256#2,>a0=int64#2
# asm 2: movq <stack_FVGS0=40(%rsp),>a0=%rsi
movq 40(%rsp),%rsi
...
# asm 1: movq <stack_FVGS1=stack256#3,>a1=int64#2
# asm 2: movq <stack_FVGS1=72(%rsp),>a1=%rsi
movq 72(%rsp),%rsi
...
# asm 1: movq <stack_FVGS2=stack256#4,>a2=int64#2
# asm 2: movq <stack_FVGS2=104(%rsp),>a2=%rsi
movq 104(%rsp),%rsi
...
# asm 1: movq <stack_FVGS3=stack256#5,>a3=int64#2
# asm 2: movq <stack_FVGS3=136(%rsp),>a3=%rsi
movq 136(%rsp),%rsi
...
# asm 1: movq <stack_FVGS4=stack256#6,>a4=int64#2
# asm 2: movq <stack_FVGS4=168(%rsp),>a4=%rsi
movq 168(%rsp),%rsi
...
# asm 1: movq <stack_FVGS5=stack256#1,>a5=int64#2
# asm 2: movq <stack_FVGS5=8(%rsp),>a5=%rsi
movq 8(%rsp),%rsi
...
# asm 1: movq <stack_FVGS7=stack256#9,>a7=int64#2
# asm 2: movq <stack_FVGS7=264(%rsp),>a7=%rsi
movq 264(%rsp),%rsi
...
# asm 1: movq <stack_FVGS8=stack256#8,>a8=int64#2
# asm 2: movq <stack_FVGS8=232(%rsp),>a8=%rsi
movq 232(%rsp),%rsi
