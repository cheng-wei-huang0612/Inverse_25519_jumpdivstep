...
a2 = mem64[input_0 + 16]
a3 = mem64[input_0 + 24]
# start with a Montgomery reduction then a conditional sub of p
minv = mem64[ table + 480]
stack_minv = minv
minv *= a0
h = 0
rax = mem64[ table + 160 ]
(uint128) rdx rax = rax * minv
t0 = rax
t1 = rdx
rax = mem64[ table + 176 ]
(uint128) rdx rax = rax * minv
...
carry? t2 += a3 + carry
       t3 +=  h + carry
# cannot carry because it is less than (2^256-1)*2^64
