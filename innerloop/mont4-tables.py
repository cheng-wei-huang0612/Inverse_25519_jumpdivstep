...
def mont4_table (prime, name, comment) :
    print('''
/* This is the %s */
static const __attribute__((aligned(32)))
int64_t t_%s[64]={0x3FFFFFFFLL, 0x3FFFFFFFLL, 0x3FFFFFFFLL, 0x3FFFFFFFLL,
...
mont4_table(radix([0xfffffffefffffc2f ,0xffffffffffffffff,
                   0xffffffffffffffff, 0xffffffffffffffff],64),"BTC_p","Bitcoin prime")
mont4_table(radix([0xbfd25e8cd0364141, 0xbaaedce6af48a03b,
		   0xfffffffffffffffe, 0xffffffffffffffff],64),"BTC_n","Bitcoin curve order prime")
mont4_table(radix([0xf3b9cac2fc632551, 0xbce6faada7179e84,
		   0xffffffffffffffff, 0xffffffff00000000],64),"P256_n","P-256 curve order prime")
mont4_table(radix([0xffffffffffffffff, 0x00000000ffffffff,
		   0x0000000000000000, 0xffffffff00000001],64),"P256_p","P-256 curve Solinas prime")
